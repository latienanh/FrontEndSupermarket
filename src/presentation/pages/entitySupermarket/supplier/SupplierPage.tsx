...
function SupplierPage() {
    ...
    useEffect(() => {
        if (supplierState.dataDelete) {
            if (hasEditDataChanged) {
                Swal.fire({
                    title: 'Deleted!',
                    text: `${supplierState.dataDelete?.message}`,
                    icon: 'success',
                });
            }
        ...
        } else if (!supplierState.isLoading && supplierState.isError) {
            toast.error('Có lỗi xảy ra khi xoá');
        }
    }, [supplierState.dataDelete]);
    const handleDeletesupplier = (id: string) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                dispatch(SupplierService.fetchDelete(id));
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="row justify-content-between">
                            <div className="col-lg-12">
                                <Link to={URL_APP.AddSupplier} className="add-btn hover-btn">
                                    Thêm mới
                                </Link>
                            </div>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div className="dropdown-menu">
                                                                                <Link
                                                                                    ...
                                                                                    to={`${URL_APP.UpdateSupplier}/${item.id}`}
                                                                                >
                                                                                    Edit
                                                                                </Link>
