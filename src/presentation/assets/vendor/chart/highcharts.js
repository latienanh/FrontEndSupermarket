...
(function (X, Q) {
    'object' === typeof module && module.exports
        ? ((Q['default'] = Q), (module.exports = X.document ? Q(X) : Q))
    ...
    Q(A, 'parts/Utilities.js', [A['parts/Globals.js']], function (d) {
        ...
        function q(a, c, k) {
            ...
            D(c)
                ? b(k)
                    ...
                    : a &&
                      a.getAttribute &&
                      ((r = a.getAttribute(c)) || 'class' !== c || (r = a.getAttribute(c + 'Name')))
                : Z(c, function (c, k) {
                      a.setAttribute(k, c);
                  });
            return r;
        ...
        var J = d.charts,
            ...
            H = (function () {
                ...
                a.prototype.run = function (a, c, k) {
                    ...
                    a !== c || this.elem['forceAnimate:' + this.prop]
                ...
                a.prototype.step = function (a) {
                    ...
                    if (r.attr && !r.element) a = !1;
                        ...
                        (this.pos = k.easing((c - this.startTime) / z)),
                ...
                a.prototype.initPath = function (a, c, k) {
                    function r(a, c) {
                        for (; a.length < p; ) {
                            ...
                            r &&
                                'M' === k[0] &&
                                (a[0] = 'C' === r[0] ? ['C', k[1], k[2], k[1], k[2], k[1], k[2]] : ['L', k[1], k[2]]);
                            a.unshift(k);
                    ...
                    function e(a, c) {
                        for (; a.length < p; )
                            if (
                                ((c = a[a.length / g - 1].slice()), 'C' === c[0] && ((c[1] = c[5]), (c[2] = c[6])), l)
                            ) {
        ...
        var p = (d.css = function (a, c) {
            ...
            B = (d.normalizeTickInterval = function (a, c, k, r, e) {
                ...
                var b = a / k;
                c ||
                    ((c = e ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
                    !1 === r &&
                        (1 === k
                ...
                for (
                    r = 0;
                    r < c.length && !((z = c[r]), (e && z * k >= a) || (!e && b <= (c[r] + (c[r + 1] || c[r])) / 2));
                    r++
                );
                return (z = P(z * k, -Math.round(Math.log(0.001) / Math.LN10)));
            }),
            ...
            T = (d.numberFormat = function (a, c, k, r) {
                ...
                if (-1 === c) c = Math.min(z, 20);
                    ...
                    var l = c + +b[1];
                    0 <= l
                        ? ((b[0] = (+b[0]).toExponential(l).split('e')[0]), (c = l))
                        : ((b[0] = b[0].split('.')[0] || 0),
                          (a = 20 > c ? (b[0] * Math.pow(10, b[1])).toFixed(c) : 0),
                          (b[1] = 0));
                }
        ...
        var ca = (d.getStyle = function (a, c, k) {
                if ('width' === c)
                    return (
                        ...
                        (k = a.getBoundingClientRect && a.getBoundingClientRect().width),
                        k < c && k >= c - 1 && (c = Math.floor(k)),
                        Math.max(0, c - d.getStyle(a, 'padding-left') - d.getStyle(a, 'padding-right'))
                    );
                if ('height' === c)
                    return Math.max(
                        0,
                        Math.min(a.offsetHeight, a.scrollHeight) -
                            d.getStyle(a, 'padding-top') -
                            d.getStyle(a, 'padding-bottom'),
                    );
                x.getComputedStyle || F(27, !0);
                if ((a = x.getComputedStyle(a, void 0)))
                    (a = a.getPropertyValue(c)), M(k, 'opacity' !== c) && (a = C(a));
                return a;
            }),
            aa = (d.inArray = function (a, c, k) {
                return c.indexOf(a, k);
            }),
            O = (d.find = Array.prototype.find
                ? function (a, c) {
                      return a.find(c);
                  }
                : function (a, c) {
                      var k,
                          r = a.length;
                      for (k = 0; k < r; k++) if (c(a[k], k)) return a[k];
                  });
        d.keys = Object.keys;
        var V = (d.offset = function (a) {
            ...
            Z = (d.objectEach = function (a, c, k) {
                for (var r in a) Object.hasOwnProperty.call(a, r) && c.call(k || a[r], a[r], r, a);
            });
        Z({ map: 'map', each: 'forEach', grep: 'filter', reduce: 'reduce', some: 'some' }, function (a, c) {
            d[c] = function (c) {
        ...
        var ha = (d.addEvent = function (a, c, k, r) {
            ...
            ea = (d.removeEvent = function (a, c, k) {
                ...
                function e(k) {
                    ...
                    if (a.nodeName) {
                        ...
                        Z(z, function (a, c) {
                            if (k[c]) for (e = k[c].length; e--; ) r(c, k[c][e].fn);
                        });
                    }
                }
                var z;
            ...
            A = (d.animate = function (a, c, k) {
                ...
                Z(c, function (l, g) {
                    ...
                    z = null;
                    'd' === g && w(c.d)
                        ? ((b.paths = b.initPath(a, a.pathArray, c.d)), (b.toD = c.d), (r = 0), (z = 1))
                        : a.attr
                        ? (r = a.attr(g))
                        : ((r = parseFloat(ca(a, g)) || 0), 'opacity' !== g && (e = 'px'));
                    z || (z = l);
        ...
        x.jQuery &&
            (x.jQuery.fn.highcharts = function () {
                var a = [].slice.call(arguments);
                if (this[0])
                    return a[0]
                        ? (new d[D(a[0]) ? a.shift() : 'Chart'](this[0], a[0], a[1]), this)
    ...
    Q(A, 'parts/Color.js', [A['parts/Globals.js'], A['parts/Utilities.js']], function (d, f) {
        ...
        f = (function () {
            ...
            d.prototype.init = function (f) {
                var q, x;
                if ((this.input = f = d.names[f && f.toLowerCase ? f.toLowerCase() : ''] || f) && f.stops)
                    ...
                    if (f && f.charAt && '#' === f.charAt()) {
                        ...
                        7 === F
                            ? (q = [(f & 16711680) >> 16, (f & 65280) >> 8, f & 255, 1])
                            : 4 === F &&
                              (q = [
                                  ((f & 3840) >> 4) | ((f & 3840) >> 8),
                                  ((f & 240) >> 4) | (f & 240),
            ...
            d.prototype.brighten = function (d) {
                ...
                if (this.stops)
                    ...
                    for (f = 0; 3 > f; f++) (x[f] += M(255 * d)), 0 > x[f] && (x[f] = 0), 255 < x[f] && (x[f] = 255);
                return this;
            };
            ...
            d.prototype.tweenTo = function (d, f) {
                ...
                q.length && x && x.length
                    ? ((d = 1 !== q[3] || 1 !== x[3]),
                      (f =
                          (d ? 'rgba(' : 'rgb(') +
                          Math.round(q[0] + (x[0] - q[0]) * (1 - f)) +
                          ',' +
                          Math.round(q[1] + (x[1] - q[1]) * (1 - f)) +
                          ',' +
                          Math.round(q[2] + (x[2] - q[2]) * (1 - f)) +
                          (d ? ',' + (q[3] + (x[3] - q[3]) * (1 - f)) : '') +
                          ')'))
                    : (f = d.input || 'none');
                return f;
        ...
        function (d, f, E) {
            ...
            E = (function () {
                ...
                B.prototype.align = function (c, a, k) {
                    ...
                    var h, p;
                    if (c) {
                        if (((this.alignOptions = c), (this.alignByTranslate = a), !k || l(k)))
                            (this.alignTo = r = k || 'renderer'), m(g, this), g.push(this), (k = void 0);
                ...
                B.prototype.animate = function (c, a, k) {
                    ...
                    0 !== r.duration
                        ? (k && (r.complete = k), C(this, c, r))
                        : (this.attr(c, void 0, k),
                          u(
                              c,
                              function (a, c) {
                                  r.step && r.step.call(this, a, { prop: c, pos: 1 });
                              },
                              this,
                          ));
                    return this;
                ...
                B.prototype.applyTextOutline = function (c) {
                    ...
                    if ((k = c[0]) && 'none' !== k && f.svg) {
                        ...
                        var e = a.textContent
                            ? /^[\u0591-\u065F\u066A-\u07FF\uFB1D-\uFDFD\uFE70-\uFEFC]/.test(a.textContent)
                            : !1;
                        var b = a.firstChild;
                        c.forEach(function (c, z) {
                            0 === z &&
                                (c.setAttribute('x', a.getAttribute('x')),
                                (z = a.getAttribute('y')),
                                c.setAttribute('y', z || 0),
                                null === z && a.setAttribute('y', 0));
                            z = c.cloneNode(!0);
                            w(e && !J ? c : z, {
                ...
                B.prototype.attr = function (c, a, k, r) {
                    ...
                    'string' === typeof c
                        ? (l = (this[c + 'Getter'] || this._defaultGetter).call(this, c, e))
                        : (u(
                              c,
                              function (a, k) {
                                  g = !1;
                                  ...
                                  g ||
                                      ((h = this[k + 'Setter'] || this._defaultSetter),
                                      h.call(this, a, k, e),
                                      !this.styledMode &&
                                          this.shadows &&
                                          /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(k) &&
                                          this.updateShadows(k, a, h));
                              },
                              this,
                          ),
                          this.afterSetters());
                ...
                B.prototype.complexColor = function (c, a, k) {
                    ...
                    g(this.renderer, 'complexColor', { args: arguments }, function () {
                        ...
                        if (b) {
                            ...
                            h(l) &&
                                (c[b] = l =
                                    { x1: l[0], y1: l[1], x2: l[2], y2: l[3], gradientUnits: 'userSpaceOnUse' });
                            'radialGradient' === b &&
                                O &&
                                !N(l.gradientUnits) &&
                                ((p = l), (l = I(l, r.getRadialAttr(O, p), { gradientUnits: 'userSpaceOnUse' })));
                            u(l, function (a, c) {
                                'id' !== c && t.push(c, a);
                            });
                            u(v, function (a) {
                            ...
                            if (m[t]) V = m[t].attr('id');
                                ...
                                v.forEach(function (a) {
                                    0 === a[1].indexOf('rgba')
                                        ? ((e = d.parse(a[1])), (y = e.get('rgb')), (n = e.get('a')))
                                        : ((y = a[1]), (n = 1));
                                    a = r
                                        .createElement('stop')
                                        .attr({ offset: a[0], 'stop-color': y, 'stop-opacity': n })
                                        .add(z);
                                    z.stops.push(a);
                                });
                            }
                ...
                B.prototype.css = function (c) {
                    ...
                    if (l) {
                        ...
                        if (c)
                            ...
                            else if ('text' === r.nodeName.toLowerCase() && c.width)
                                var h = (this.textWidth = G(c.width));
                        this.styles = c;
                        ...
                        this.added &&
                            ...
                            c && c.textOutline && this.applyTextOutline(c.textOutline));
                    }
                    return this;
                };
                ...
                B.prototype.getBBox = function (c, a) {
                    ...
                    if (!k) {
                        ...
                        r.isSVG &&
                            ...
                            u &&
                                (k.height = r =
                                    { '11px,17': 14, '13px,20': 16 }[l && l.fontSize + ',' + Math.round(r)] || r),
                            a &&
                                ((l = a * q),
                                (k.width = Math.abs(r * Math.sin(l)) + Math.abs(c * Math.cos(l))),
                                (k.height = Math.abs(r * Math.cos(l)) + Math.abs(c * Math.sin(l)))));
                        if (v && 0 < k.height) {
                        ...
                        ? ((e.ontouchstart = function (a) {
                          ...
                          (e.ontouchend = function (c) {
                              (k &&
                                  4 <=
                                      Math.sqrt(
                                          Math.pow(k - c.changedTouches[0].clientX, 2) +
                                              Math.pow(r - c.changedTouches[0].clientY, 2),
                                      )) ||
                                  a.call(e, c);
                              b = !0;
                              c.preventDefault();
                ...
                B.prototype.removeClass = function (c) {
                    return this.attr(
                        'class',
                        ('' + this.attr('class')).replace(l(c) ? new RegExp(' ?' + c + ' ?') : c, ''),
                    );
                };
                B.prototype.removeTextOutline = function (c) {
                    for (var a = c.length, k; a--; )
                        (k = c[a]),
                            'highcharts-text-outline' === k.getAttribute('class') && m(c, this.element.removeChild(k));
                };
                ...
                B.prototype.setTextPath = function (c, a) {
                    ...
                    if (c && a && a.enabled) {
                        ...
                        if (l)
                            for (c = k.getElementsByTagName('tspan'); c.length; )
                                c[0].setAttribute('y', 0),
                                    p(g.dx) && c[0].setAttribute('x', -g.dx),
                                    h.appendChild(c[0]);
                ...
                B.prototype.shadow = function (c, a, k) {
                    ...
                    var h = { color: '#000000', offsetX: 1, offsetY: 1, opacity: 0.15, width: 3 };
                    var p;
                ...
                B.prototype.strokeSetter = function (c, a, k) {
                    ...
                    this.stroke && this['stroke-width']
                        ? (B.prototype.fillSetter.call(this, this.stroke, 'stroke', k),
                ...
                B.prototype.updateShadows = function (c, a, k) {
                    ...
                    if (r)
                        for (var e = r.length; e--; )
                            k.call(
                                r[e],
                                'height' === c ? Math.max(a - (r[e].cutHeight || 0), 0) : 'd' === c ? this.d : a,
                                c,
                                r[e],
                            );
                };
                        ...
                        : b &&
                          c.push(
                              'rotate(' +
                                  b +
                                  ' ' +
                                  y(this.rotationOriginX, g.getAttribute('x'), 0) +
                                  ' ' +
                ...
                B.prototype.zIndexSetter = function (c, a) {
                    ...
                    var h;
                    N(c)
                        ? (b.setAttribute('data-z-index', c), (c = +c), this[a] === c && (g = !1))
                        : N(this[a]) && b.removeAttribute('data-z-index');
                    this[a] = c;
                    if (g) {
                        ...
                        for (h = a.length - 1; 0 <= h && !l; h--) {
                            ...
                            if (r !== b)
                                ...
                                else if (G(g) <= c || (p && (!N(c) || 0 <= c)))
                                    e.insertBefore(b, a[h + 1] || null), (l = !0);
                        }
    ...
    Q(
        ...
        [A['parts/Color.js'], A['parts/Globals.js'], A['parts/SVGElement.js'], A['parts/Utilities.js']],
        function (d, f, E, q) {
            var M = d.parse,
                K = q.addEvent,
                J = q.attr,
            ...
            C(d.prototype, {
                ...
                init: function (a, k, r, e, b, l, g) {
                    ...
                    this.alignedObjects = [];
                    this.url =
                        (u || G) && I.getElementsByTagName('base').length
                            ? c.location.href
                                  .split('#')[0]
                                  .replace(/<[^>]*>/g, '')
                                  .replace(/([\('\)])/g, '\\$1')
                    ...
                    this.createElement('desc')
                        .add()
                        .element.appendChild(I.createTextNode('Created with Highcharts 8.1.0'));
                    ...
                    u &&
                        ...
                        k(),
                        (this.unSubPixelFix = K(c, 'resize', k)));
                },
                ...
                buildText: function (a) {
                    ...
                    var f = function (a) {
                        ...
                        C = function (a, c) {
                            ...
                            k = a.indexOf(c + '=');
                            if (-1 !== k && ((k = k + c.length + 1), (c = a.charAt(k)), '"' === c || "'" === c))
                                return (a = a.substring(k + 1)), a.substring(0, a.indexOf(c));
                        },
                        D = /<br.*?>/g;
                    var q = [l, t, G, O, V, d, n].join();
                    if (q !== a.textCache) {
                        for (a.textCache = q; B--; ) c.removeChild(p[B]);
                        h || V || t || n || (-1 !== l.indexOf(' ') && (!G || D.test(l)))
                            ? (y && y.appendChild(c),
                              h
                                  ? ((l = r.styledMode
                                        ? l
                              ...
                              l.forEach(function (k, b) {
                                  ...
                                  z.forEach(function (k) {
                                      if ('' !== k || 1 === z.length) {
                                          ...
                                          if ((m = C(k, 'style')))
                                              (m = m.replace(/(;| |^)color([ :])/, '$1fill$2')), J(p, 'style', m);
                                          (P = C(k, 'href')) &&
                                              !e &&
                                              (J(p, 'onclick', 'location.href="' + P + '"'),
                                              J(p, 'class', 'highcharts-anchor'),
                                              r.styledMode || x(p, { cursor: 'pointer' }));
                                                  ...
                                                  if (t)
                                                      ...
                                                      for (; O.length; )
                                                          O.length &&
                                                              !G &&
                                                              0 < P &&
                                                              ((p = I.createElementNS(R, 'tspan')),
                                                              J(p, { dy: y, x: v }),
                                                              m && J(p, 'style', m),
                                                              p.appendChild(
                                                                  I.createTextNode(O.join(' ').replace(/- /g, '-')),
                                                              ),
                                                              c.appendChild(p)),
                                                              r.truncate(
                                                                  a,
                              ...
                              t && u && a.attr('title', N(a.textStr, ['&lt;', '&gt;'])),
                              y && y.removeChild(c),
                              V && a.applyTextOutline && a.applyTextOutline(V))
                            : c.appendChild(I.createTextNode(N(l)));
                    }
                },
                ...
                rect: function (a, c, r, e, b, l) {
                    ...
                    a = n(a)
                        ...
                        : 'undefined' === typeof a
                        ? {}
                        : { x: a, y: c, width: Math.max(r, 0), height: Math.max(e, 0) };
                    this.styledMode ||
                        ('undefined' !== typeof l && ((a.strokeWidth = l), (a = k.crisp(a))), (a.fill = 'none'));
                    b && (a.r = b);
                ...
                image: function (a, k, r, e, b, l) {
                    ...
                    l
                        ? (h(p.element, 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='),
                          (g = new c.Image()),
                          K(g, 'load', z),
                          (g.src = a),
                          g.complete && z({}))
                ...
                symbol: function (a, c, r, e, l, g) {
                    ...
                    if (m) {
                        'number' === typeof c &&
                            (v = m.call(this.symbols, Math.round(c || 0), Math.round(r || 0), e, l, g));
                        var P = this.path(v);
                            ...
                            P[a + 'Setter'] = function (a, c) {
                                ...
                                F(r) &&
                                    (g &&
                                        ...
                                        this.height &&
                                        (r = Math.round(
                                            r * Math.min(this.width / this.imgwidth, this.height / this.imgheight),
                                        )),
                                    this.element && this.element.setAttribute(c, r),
                                    this.alignByTranslate || ((k[e] = ((this[c] || 0) - r) / 2), this.attr(k)));
                            };
                        });
                        F(c) && P.attr({ x: c, y: r });
                        P.isImg = !0;
                        F(P.imgwidth) && F(P.imgheight)
                            ? n()
                            : (P.attr({ width: 0, height: 0 }),
                              L('img', {
                                  onload: function () {
                                      ...
                                      0 === this.width &&
                                          (x(this, { position: 'absolute', top: '-999em' }), I.body.appendChild(this));
                ...
                symbols: {
                    ...
                    arc: function (a, c, r, e, l) {
                        var k = l.start,
                            ...
                            p = l.end - 0.001;
                        r = l.innerR;
                        e = b(l.open, 0.001 > Math.abs(l.end - l.start - 2 * Math.PI));
                        var z = Math.cos(k),
                            u = Math.sin(k),
                            m = Math.cos(p);
                        p = Math.sin(p);
                        k = b(l.longArc, 0.001 > l.end - k - Math.PI ? 0 : 1);
                        g = [
                            ['M', a + g * z, c + h * u],
                            ['A', g, h, 0, k, b(l.clockwise, 1), a + g * m, c + h * p],
                        ];
                        F(r) &&
                            g.push(e ? ['M', a + r * m, c + r * p] : ['L', a + r * m, c + r * p], [
                                'A',
                                r,
                                r,
                                0,
                                k,
                                F(l.clockwise) ? 1 - l.clockwise : 0,
                                a + r * z,
                                c + r * u,
                            ]);
                        e || g.push(['Z']);
                    ...
                    callout: function (a, c, r, e, b) {
                        ...
                        g && g > r
                            ...
                            : g && 0 > g
                            ? b > c + l && b < c + e - l
                                ? h.splice(7, 1, ['L', a, b + 6], ['L', a - 6, b], ['L', a, b - 6], ['L', a, c + k])
                                : h.splice(7, 1, ['L', a, e / 2], ['L', g, b], ['L', a, e / 2], ['L', a, c + k])
                            : b && b > e && g > a + l && g < a + r - l
                            ? h.splice(
                                  5,
                                  1,
                            ...
                            : b &&
                              ...
                              g > a + l &&
                              g < a + r - l &&
                              h.splice(1, 1, ['L', g - 6, c], ['L', g, c - 6], ['L', g + 6, c], ['L', r - k, c]);
                        return h;
                    },
                },
                ...
                fontMetrics: function (a, k) {
                    a =
                        (!this.styledMode && /px/.test(a)) || !c.getComputedStyle
                            ? a || (k && k.style && k.style.fontSize) || (this.style && this.style.fontSize)
                            : k && E.prototype.getStyle.call(k, 'font-size');
                    a = /px/.test(a) ? g(a) : 12;
                    k = 24 > a ? a + 3 : Math.round(1.2 * a);
                    return { h: k, b: Math.round(0.8 * k), f: a };
                },
                ...
                pathToSegments: function (a) {
                    for (
                        var c = [], e = [], b = { A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2 }, l = 0;
                        l < a.length;
                        l++
                    )
                        t(e[0]) &&
                            w(a[l]) &&
                            e.length === b[e[0].toUpperCase()] &&
                            a.splice(l, 0, e[0].replace('M', 'L').replace('m', 'l')),
                            'string' === typeof a[l] && (e.length && c.push(e.slice(0)), (e.length = 0)),
                            e.push(a[l]);
                    c.push(e.slice(0));
                    return c;
                },
                label: function (a, c, e, b, l, g, h, p, u) {
                    ...
                    var Y = function () {
                        ...
                        D &&
                            (y ||
                                ((z.box = y = k.symbols[b] || T ? k.symbol(b) : k.rect()),
                                y.addClass(
                                    ('button' === u ? '' : 'highcharts-label-box') +
                                        (u ? ' highcharts-' + u + '-box' : ''),
                                ),
                                y.add(z),
                                (a = q()),
                                (c.x = a),
                                (c.y = (p ? -W : 0) + a)),
                            (c.width = Math.round(z.width)),
                            (c.height = Math.round(z.height)),
                            y.attr(C(c, R)),
                            (R = {}));
                    };
                    var H = function () {
                        ...
                        F(U) &&
                            n &&
                            ('center' === S || 'right' === S) &&
                            (a += { center: 0.5, right: 1 }[S] * (U - n.width));
                        if (a !== m.x || c !== m.y)
                            m.attr('x', a),
                                m.hasBoxWidthChanged && ((n = m.getBBox(!0)), Y()),
                                'undefined' !== typeof c && m.attr('y', c);
                        m.x = a;
                        m.y = c;
                    };
                    var L = function (a, c) {
                    ...
                    h = {
                        ...
                        getBBox: function () {
                            return { width: n.width + 2 * I, height: n.height + 2 * I, x: n.x - I, y: n.y - I };
                        },
                        destroy: function () {
                        ...
                        if (k) {
                            var e = function (e) {
                                (('mouseenter' === a || 'mouseleave' === a) &&
                                    ...
                                    (z.element.contains(e.relatedTarget) || k.element.contains(e.relatedTarget))) ||
                                    c.call(z.element, e);
                            };
                            k.on(a, e);
                        }
    ...
    Q(A, 'parts/Html.js', [A['parts/Globals.js'], A['parts/Utilities.js']], function (d, f) {
                ...
                if (this.added) {
                    ...
                    !n.styledMode &&
                        ...
                        this.shadows.forEach(function (e) {
                            M(e, { marginLeft: d + 1, marginTop: m + 1 });
                        });
                    this.inverted &&
                        [].forEach.call(t.childNodes, function (e) {
                            n.invertChild(e, t);
                        });
                    if ('SPAN' === t.tagName) {
                        e = this.rotation;
                        var l = this.textWidth && x(this.textWidth),
                            ...
                            u;
                        (u = l !== this.oldTextWidth) &&
                            !(u = l > this.oldTextWidth) &&
                            ((u = this.textPxLength) ||
                                (M(t, { width: '', whiteSpace: p || 'nowrap' }), (u = t.offsetWidth)),
                            (u = u > l));
                        u && (/[ \-]/.test(t.textContent || t.innerText) || 'ellipsis' === t.style.textOverflow)
                            ? (M(t, { width: l + 'px', display: 'block', whiteSpace: p || 'normal' }),
                              (this.oldTextWidth = l),
                              (this.hasBoxWidthChanged = !0))
                            : (this.hasBoxWidthChanged = !1);
                        I !== this.cTT &&
                            ((p = n.fontMetrics(t.style.fontSize, t).b),
                            !K(e) ||
                                (e === (this.oldRotation || 0) && v === this.oldAlign) ||
                                this.setSpanRotation(e, h, p),
                            this.getSpanCorrection((!K(e) && this.textPxLength) || t.offsetWidth, p, h, e, v));
        ...
        J(f.prototype, {
            getTransformKey: function () {
                return H && !/Edge/.test(w.navigator.userAgent)
                    ? '-ms-transform'
                    : C
                    ? '-webkit-transform'
                    : F
                            ...
                            if (!v) {
                                ...
                                l.reverse().forEach(function (e) {
                                    ...
                                    J(e, {
                                        ...
                                        on: function () {
                                            l[0].div && m.on.apply({ element: l[0].div }, arguments);
                                            return e;
                                        },
                                        translateXSetter: b,
                                        translateYSetter: b,
    ...
    Q(A, 'parts/Tick.js', [A['parts/Globals.js'], A['parts/Utilities.js']], function (d, f) {
        ...
        f = (function () {
            ...
            d.prototype.addLabel = function () {
                ...
                var y, G;
                if (t.dateTime && p) {
                    var f = m.time.resolveDTLFormat(
                        d.dateTimeLabelFormats[(!d.grid && p.higherRanks[h]) || p.unitName],
                    );
                    var w = f.main;
                }
                n.isFirst = l;
                ...
                if ((G = f && f.list))
                    n.shortenLabel = function () {
                        for (y = 0; y < G.length; y++)
                            if (
                                (u.attr({ text: t.labelFormatter.call(J(n.formatCtx, { dateTimeLabelFormat: G[y] })) }),
                                u.getBBox().width < t.getSlotWidth(n) - 2 * C(e.padding, 5))
                            )
                                return;
                        u.attr({ text: '' });
                    };
                ...
                M(u) || n.movedLabel
                    ? u &&
                      u.textStr !== d &&
                      !b &&
                      (!u.textWidth || (e.style && e.style.width) || u.styles.width || u.css({ width: null }),
                      u.attr({ text: d }),
                      (u.textPxLength = u.getBBox().width))
                    : ((n.label = u = n.createLabel({ x: 0, y: 0 }, d, e)), (n.rotation = 0));
            };
            d.prototype.createLabel = function (n, t, d) {
                var m = this.axis,
                    b = m.chart;
                if ((n = M(t) && d.enabled ? b.renderer.text(t, n.x, n.y, d.useHTML).add(m.labelGroup) : null))
                    b.styledMode || n.css(F(d.style)), (n.textPxLength = n.getBBox().width);
                return n;
            };
            ...
            d.prototype.getPosition = function (n, t, d, m) {
                ...
                n = {
                    x: n
                        ? q(b.translate(t + d, null, null, m) + b.transB)
                        : b.left +
                          b.offset +
                          (b.opposite ? ((m && g.oldChartWidth) || g.chartWidth) - b.right - b.left : 0),
                    y: n
                        ? v - b.bottom + b.offset - (b.opposite ? b.height : 0)
                        : q(v - b.translate(t + d, null, null, m) - b.transB),
                };
                n.y = E(n.y, -1e5, 1e5);
            ...
            d.prototype.getLabelPosition = function (n, t, d, m, b, g, v, h) {
                var e = this.axis,
                    ...
                    y = b.y,
                    G = m || e.reserveSpaceDefault ? 0 : -e.labelOffset * ('center' === e.labelAlign ? 0.5 : 1),
                    f = {};
                M(y) ||
                    (y =
                        0 === e.side
                            ...
                            : 2 === e.side
                            ? u.y + 8
                            : Math.cos(d.rotation * D) * (u.y - d.getBBox(!1, 0).height / 2));
            ...
            d.prototype.handleOverflow = function (n) {
                ...
                var h = this.label,
                    e = this.rotation,
                    p = { left: 0, center: 0.5, right: 1 }[d.labelAlign || h.attr('align')],
                    l = h.getBBox().width,
                    ...
                    G,
                    w = {};
                if (e || 'justify' !== C(f.overflow, 'justify'))
                    0 > e && m - p * l < v
                        ? (G = Math.round(m / Math.cos(e * D) - v))
                        : 0 < e && m + p * l > g && (G = Math.round((b - m) / Math.cos(e * D)));
                else if (
                    ((b = m + (1 - p) * l),
                    m - p * l < v ? (u = n.x + u * (1 - p) - v) : b > g && ((u = g - n.x + u * p), (y = -1)),
                    (u = Math.min(I, u)),
                    u < I && 'center' === d.labelAlign && (n.x += y * (I - u - p * (I - Math.min(l, u)))),
                    l > u || (d.autoRotation && (h.styles || {}).width))
                )
                    G = u;
                G &&
                    (this.shortenLabel
                        ? this.shortenLabel()
                        : ((w.width = Math.floor(G) + 'px'),
                          (f.style || {}).textOverflow || (w.textOverflow = 'ellipsis'),
                          h.css(w)));
            };
            d.prototype.moveLabel = function (n, d) {
                var t = this,
                    ...
                    h = g.chart.inverted;
                m && m.textStr === n
                    ? ((t.movedLabel = m), (b = !0), delete t.label)
                    : H(g.ticks, function (e) {
                          b ||
                              e.isNew ||
                              e === t ||
                              !e.label ||
                              e.label.textStr !== n ||
                              ((t.movedLabel = e.label), (b = !0), (e.labelPos = t.movedLabel.xy), delete e.label);
                      });
                if (!b && (t.labelPos || m)) {
            ...
            d.prototype.renderGridLine = function (n, d, f) {
                ...
                b = b[I + 'LineDashStyle'];
                g ||
                    (m.chart.styledMode || ((v.stroke = y), (v['stroke-width'] = u), b && (v.dashstyle = b)),
                    e || (v.zIndex = 1),
                    n && (d = 0),
                    (this.gridLine = g =
                        l
                ...
                if (
                    g &&
                    (f = m.getPlotLinePath({ value: h + p, lineWidth: g.strokeWidth() * f, force: 'pass', old: n }))
                )
                    g[n || this.isNew ? 'attr' : 'animate']({ d: f, opacity: d });
            };
                ...
                e &&
                    ...
                    l &&
                        ((this.mark = p =
                            g
                                .path()
                                .addClass('highcharts-' + (v ? v + '-' : '') + 'tick')
                                .add(m.axisGroup)),
                        m.chart.styledMode || p.attr({ stroke: b, 'stroke-width': u })),
                    p[l ? 'attr' : 'animate']({
            ...
            d.prototype.renderLabel = function (n, d, f, m) {
                ...
                h &&
                    x(I) &&
                    ((h.xy = n = this.getLabelPosition(I, n, h, g, e, b, m, p)),
                    (this.isFirst && !this.isLast && !C(v.showFirstLabel, 1)) ||
                    (this.isLast && !this.isFirst && !C(v.showLastLabel, 1))
                        ? (l = !1)
                        : !g || e.step || e.rotation || d || 0 === f || this.handleOverflow(n),
                    p && m % p && (l = !1),
                    l && x(n.y)
                        ? ((n.opacity = f), h[this.isNewLabel ? 'attr' : 'animate'](n), (this.isNewLabel = !1))
    ...
    Q(A, 'parts/Time.js', [A['parts/Globals.js'], A['parts/Utilities.js']], function (d, f) {
        ...
        f = (function () {
            ...
            f.prototype.dateFormat = function (n, f, w) {
                var m;
                if (!E(f) || isNaN(f))
                    return (null === (m = d.defaultOptions.lang) || void 0 === m ? void 0 : m.invalidDate) || '';
                n = F(n, '%Y-%m-%d %H:%M:%S');
                var b = this;
                m = new this.Date(f);
            ...
            f.prototype.resolveDTLFormat = function (d) {
                return K(d, !0) ? d : ((d = H(d)), { main: d[0], from: d[1], to: d[2] });
            };
            f.prototype.getTimeTicks = function (d, f, w, m) {
                ...
                if (E(f)) {
                    ...
                    e >= C.day &&
                        b.set('Date', h, e >= C.month ? 1 : Math.max(1, p * Math.floor(b.get('Date', h) / p)));
                    if (e >= C.month) {
                    ...
                    e === C.week &&
                        ((n = b.get('Day', h)), b.set('Date', h, b.get('Date', h) - n + m + (n < m ? -7 : 0)));
                    n = b.get('FullYear', h);
                    m = b.get('Month', h);
                    var u = b.get('Date', h),
                        y = b.get('Hours', h);
                    f = h.getTime();
                    b.variableTimezone &&
                        (l = w - f > 4 * C.month || b.getTimezoneOffset(f) !== b.getTimezoneOffset(w));
                    f = h.getTime();
                    for (h = 1; f < w; )
                        g.push(f),
                            (f =
                                e === C.year
                                    ...
                                    : !l || (e !== C.day && e !== C.week)
                                    ? l && e === C.hour && 1 < p
                                        ? b.makeTime(n, m, u, y + h * p)
                                        : f + e * p
                                    : b.makeTime(n, m, u + h * p * (e === C.day ? 1 : 7))),
                            h++;
                    g.push(f);
                    e <= C.hour &&
                        1e4 > g.length &&
    ...
    Q(
        A,
        'parts/Options.js',
        [A['parts/Globals.js'], A['parts/Time.js'], A['parts/Color.js'], A['parts/Utilities.js']],
        function (d, f, E, q) {
            E = E.parse;
            var M = q.merge;
            d.defaultOptions = {
            ...
            d.setOptions = function (f) {
                ...
                (f.time || f.global) &&
                    d.time.update(M(d.defaultOptions.global, d.defaultOptions.time, f.global, f.time));
    ...
    Q(
        A,
        'parts/Axis.js',
        [A['parts/Color.js'], A['parts/Globals.js'], A['parts/Tick.js'], A['parts/Utilities.js']],
        function (d, f, E, q) {
            var M = q.addEvent,
                K = q.animObject,
                J = q.arrayMax,
            ...
            q = (function () {
                ...
                B.prototype.init = function (c, a) {
                    ...
                    a = e.options.events;
                    -1 === c.axes.indexOf(e) &&
                        (k ? c.axes.splice(c.xAxis.length, 0, e) : c.axes.push(e), c[e.coll].push(e));
                    e.series = e.series || [];
                ...
                B.prototype.defaultLabelFormatter = function () {
                    ...
                    if (p) var v = t(p, this, m);
                        ...
                        for (; h-- && 'undefined' === typeof v; )
                            (k = Math.pow(l, h + 1)),
                                c >= k && 0 === (10 * a) % k && null !== g[h] && 0 !== a && (v = u(a / k, -1) + g[h]);
                            ...
                            if (e.visible || !a.options.chart.ignoreHiddenSeries) {
                                ...
                                if (c.isXAxis) {
                                    if (((b = e.xData), b.length)) {
                                        ...
                                        g(h) ||
                                            h instanceof Date ||
                                            ((b = b.filter(g)), (k = e.getXExtremes(b)), (h = k.min), (p = k.max));
                                        b.length &&
                                            ((c.dataMin = Math.min(l(c.dataMin, h), h)),
                                            (c.dataMax = Math.max(l(c.dataMax, p), p)));
                                    }
                                } else if (
                                    ((e = e.applyExtremes()),
                                    g(e.dataMin) && ((h = e.dataMin), (c.dataMin = Math.min(l(c.dataMin, h), h))),
                                    g(e.dataMax) && ((p = e.dataMax), (c.dataMax = Math.max(l(c.dataMax, p), p))),
                                    H(r) && (c.threshold = r),
                ...
                B.prototype.translate = function (c, a, k, e, b, l) {
                    ...
                    a
                        ? ((c = (c * h + p - m) / z + e), b && (c = r.lin2val(c)))
                        : (b && (c = r.val2lin(c)),
                          (c = g(e) ? h * (c - e) * z + p + h * m + (g(l) ? z * l : 0) : void 0));
                    return c;
                };
                ...
                B.prototype.getPlotLinePath = function (c) {
                    ...
                    n(this, 'getPlotLinePath', c, function (c) {
                        ...
                        g(u)
                            ? k.horiz
                                ? ((O = h), (I = G - k.bottom), (y = f = a(y, b, b + k.width)))
                                : ((y = b), (f = t - k.right), (O = I = a(O, h, h + k.height)))
                            : ((B = !0), (d = !1));
                        c.path =
                            B && !d
                                ? null
                ...
                B.prototype.getMinorTickPositions = function () {
                    ...
                    if (g && g / k < this.len / 3) {
                        ...
                        if (h)
                            ...
                            e = e.concat(
                                this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(k), l, b, c.startOfWeek),
                            );
                        else for (c = l + ((a[0] - l) % k); c <= b && c !== e[0]; c += k) e.push(c);
                    }
                    ...
                    0 < a.length &&
                        ...
                        (this.series || []).forEach(function (a) {
                            ...
                            if (!a.points || a.isDirtyData)
                                (c.max = Math.max(c.max, a.xData.length - 1)), a.processData(), a.generatePoints();
                ...
                B.prototype.setAxisTranslation = function (c) {
                    ...
                    if (d || m || b) {
                        var y = a.getClosest();
                        p
                            ? ((g = p.minPointOffset), (h = p.pointRangePadding))
                            : a.series.forEach(function (c) {
                                  ...
                                  if (!a.single || m)
                                      (c = c.is('xrange') ? !d : d),
                                          (g = Math.max(g, c && v(k) ? 0 : e / 2)),
                                          (h = Math.max(h, c && 'on' === k ? 0 : e));
                              });
                ...
                B.prototype.setTickInterval = function (c) {
                    ...
                    b &&
                        (a.positiveValuesOnly && !c && 0 >= Math.min(a.min, l(a.dataMin, a.min)) && D(10, 1, k),
                        (a.min = F(b.log2lin(a.min), 16)),
                        (a.max = F(b.log2lin(a.max), 16)));
                    a.range &&
                        H(a.max) &&
                        ((a.userMin = a.min = G = Math.max(a.dataMin, a.minFromRange())),
                        (a.userMax = t = a.max),
                        (a.range = null));
                    n(a, 'foundExtremes');
                    a.beforePadding && a.beforePadding();
                    a.adjustForMinRange();
                    !(f || a.axisPointRange || (a.stacking && a.stacking.usePercentage) || m) &&
                        H(a.min) &&
                        H(a.max) &&
                        (k = a.max - a.min) &&
                        (!H(G) && v && (a.min -= k * v), !H(t) && u && (a.max += k * u));
                    g(a.userMin) ||
                        (g(h.softMin) && h.softMin < a.min && (a.min = G = h.softMin),
                        g(h.floor) && (a.min = Math.max(a.min, h.floor)));
                    g(a.userMax) ||
                        (g(h.softMax) && h.softMax > a.max && (a.max = t = h.softMax),
                        g(h.ceiling) && (a.max = Math.min(a.max, h.ceiling)));
                    I &&
                        H(a.dataMin) &&
                        ((O = O || 0),
                        !H(G) && a.min < O && a.dataMin >= O
                            ? (a.min = a.options.minRange ? Math.min(O, a.max - a.minRange) : O)
                            : !H(t) &&
                              a.max > O &&
                              a.dataMax <= O &&
                              (a.max = a.options.minRange ? Math.max(O, a.min + a.minRange) : O));
                    a.tickInterval =
                        a.min === a.max || 'undefined' === typeof a.min || 'undefined' === typeof a.max
                            ? 1
                            : m && !d && y === a.linkedParent.options.tickPixelInterval
                            ? (d = a.linkedParent.tickInterval)
                            : l(
                                  d,
                                  this.tickAmount ? (a.max - a.min) / Math.max(this.tickAmount - 1, 1) : void 0,
                                  f ? 1 : ((a.max - a.min) * y) / Math.max(a.len, y),
                              );
                    p &&
                        !c &&
                        a.series.forEach(function (c) {
                    ...
                    a.dateTime ||
                        ...
                        (a.tickInterval = e(
                            ...
                            void 0,
                            N(a.tickInterval),
                            l(h.allowDecimals, 0.5 > a.tickInterval || void 0 !== this.tickAmount),
                            !!this.tickAmount,
                        ));
                ...
                B.prototype.setTickPositions = function () {
                    ...
                    !e &&
                        ...
                        !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))
                            ...
                            : ((e = [this.min, this.max]), D(19, !1, this.chart)),
                        e.length > this.len && ((e = [e[0], e.pop()]), e[0] === e[1] && (e.length = 1)),
                        (this.tickPositions = e),
                        b && (b = b.apply(this, [this.min, this.max]))) &&
                        (this.tickPositions = e = b);
                ...
                B.prototype.trimTicks = function (c, a, e) {
                    ...
                    if (!this.isLinked) {
                        ...
                        else for (; this.min - l > c[0]; ) c.shift();
                        if (e) this.max = b;
                        else for (; this.max + l < c[c.length - 1]; ) c.pop();
                ...
                B.prototype.unsquish = function () {
                    ...
                    a
                        ? (d =
                              !c.staggerLines &&
                              !c.step &&
                              (H(p) ? [p] : g < l(c.autoRotationLimit, 80) && c.autoRotation)) &&
                ...
                B.prototype.getSlotWidth = function (c) {
                    ...
                    if (!b) {
                        c =
                            null === (a = null === l || void 0 === l ? void 0 : l.style) || void 0 === a
                                ? void 0
                                : a.width;
                ...
                B.prototype.renderUnsquish = function () {
                    ...
                    if (this.autoRotation)
                        f > m && f > d.h ? (u.rotation = this.labelRotation) : (this.labelRotation = 0);
                    else if (p) {
                        var n = m;
                        if (!y) {
                            var I = 'clip';
                            for (m = e.length; !h && m--; ) {
                                ...
                                if ((G = b[G].label))
                                    G.styles && 'ellipsis' === G.styles.textOverflow
                                        ...
                                        : G.textPxLength > p && G.css({ width: p + 'px' }),
                                        G.getBBox().height > this.len / e.length - (d.h - d.f) &&
                                            (G.specificTextOverflow = 'ellipsis');
                            }
                        }
                    }
                    u.rotation && ((n = f > 0.5 * c.chartHeight ? 0.33 * c.chartHeight : f), y || (I = 'ellipsis'));
                    ...
                    e.forEach(function (a) {
                        ...
                        c &&
                            ...
                            a.shortenLabel
                                ...
                                ? ((k.width = n + 'px'), y || (k.textOverflow = c.specificTextOverflow || I), c.css(k))
                                : c.styles && c.styles.width && !k.width && !e && c.css({ width: null }),
                        ...
                        ((g = l.textAlign) ||
                            (g = (
                                e
                                    ...
                                    : { low: b ? 'right' : 'left', middle: 'center', high: b ? 'left' : 'right' }
                            )[l.align]),
                        (this.axisTitle = a
                            .text(l.text, 0, 0, l.useHTML)
                            .attr({ zIndex: 7, rotation: l.rotation || 0, align: g })
                            .addClass('highcharts-axis-title')),
                        p || this.axisTitle.css(h(l.style)),
                ...
                B.prototype.getOffset = function () {
                    ...
                    c.axisGroup ||
                        ...
                        (c.labelGroup = e
                            .g('axis-labels')
                            .attr({ zIndex: I.zIndex || 7 })
                            .addClass('highcharts-' + c.coll.toLowerCase() + '-labels ' + (w || ''))
                            .add(S)));
                    R || c.isLinked
                        ? (g.forEach(function (a, e) {
                          ...
                          c.renderUnsquish(),
                          (c.reserveSpaceDefault = 0 === u || 2 === u || { 1: 'left', 3: 'right' }[u] === c.labelAlign),
                          l(I.reserveSpace, 'center' === c.labelAlign ? !0 : null, c.reserveSpaceDefault) &&
                              g.forEach(function (a) {
                                  G = Math.max(h[a].getLabelSize(), G);
                              }),
                          c.staggerLines && (G *= c.staggerLines),
                          (c.labelOffset = G * (c.opposite ? -1 : 1)))
                        : p(h, function (a, c) {
                              a.destroy();
                              delete h[c];
                          });
                    ...
                    t[u] = Math.max(
                        t[u],
                        c.axisTitleMargin + y + B * c.offset,
                        f,
                        g && g.length && m ? m[0] + B * c.offset : 0,
                    );
                ...
                B.prototype.getLinePath = function (c) {
                    ...
                    return a.renderer.crispLine(
                        [
                            ...
                            ['L', l ? a.chartWidth - this.right : g, l ? b : a.chartHeight - this.bottom],
                        ],
                        c,
                    );
                };
                ...
                B.prototype.renderTick = function (c, a) {
                    ...
                    if (!e || (c >= this.min && c <= this.max))
                        b[c] || (b[c] = new E(this, c)), l && b[c].isNew && b[c].render(a, !0, -1), b[c].render(a);
                };
                B.prototype.render = function () {
                    ...
                    if (c.hasData() || l)
                        c.minorTickInterval &&
                            ...
                            h.length &&
                                ...
                                O &&
                                    (0 === c.min || c.single) &&
                                    (u[-1] || (u[-1] = new E(c, -1, null, !0)), u[-1].render(-1))),
                            I &&
                                h.forEach(function (k, b) {
                                    R = 'undefined' !== typeof h[b + 1] ? h[b + 1] + O : c.max - O;
                                    0 === b % 2 &&
                                        k < c.max &&
                                        R <= c.max + (a.polar ? -O : O) &&
                                        (v[k] || (v[k] = new f.PlotLineOrBand(c)),
                                        (S = k + O),
                                        (v[k].options = {
                            ...
                            c._addedPlotLB ||
                                ((b.plotLines || []).concat(b.plotBands || []).forEach(function (a) {
                    ...
                    t &&
                        (t[t.isPlaced ? 'animate' : 'attr']({ d: this.getLinePath(t.strokeWidth()) }),
                        (t.isPlaced = !0),
                        t[B ? 'show' : 'hide'](B));
                    m &&
                        B &&
                ...
                B.prototype.drawCrosshair = function (c, a) {
                    ...
                    if (this.crosshair && !1 !== (H(a) || !b)) {
                        ...
                        if (H(g)) {
                            ...
                            p.polar &&
                                w(m, { isCrosshair: !0, chartX: c && c.chartX, chartY: c && c.chartY, point: a });
                        ...
                        h ||
                            ((this.cross = h =
                                p.renderer
                                    ...
                                    .attr({ zIndex: l(e.zIndex, 2) })
                                    .add()),
                            p.styledMode ||
                                (h
                                    .attr({
                                        stroke: e.color || (b ? d.parse('#ccd6eb').setOpacity(0.25).get() : '#cccccc'),
                                        'stroke-width': l(e.width, 1),
                                    })
                                    .css({ 'pointer-events': 'none' }),
                                e.dashStyle && h.attr({ dashstyle: e.dashStyle })));
                        h.show().attr({ d: m });
                ...
                B.prototype.hasVerticalPanning = function () {
                    var c, a;
                    return /y/.test(
                        (null === (a = null === (c = this.chart.options.chart) || void 0 === c ? void 0 : c.panning) ||
                        void 0 === a
                            ? void 0
                            : a.type) || '',
                    );
            ...
            J = (function () {
                ...
                d.prototype.normalizeTimeTickInterval = function (d, f) {
                    ...
                    for (
                        ...
                        (C = K[f[0]]),
                        (D = f[1]),
                        x[w + 1] && d <= (C * D[D.length - 1] + K[x[w + 1][0]]) / 2);
                        w++
                    );
        ...
        var E = f.addEvent,
            ...
            J = (function () {
                ...
                d.prototype.getLogTickPositions = function (d, f, H, C) {
                    ...
                    if (0.5 <= d) (d = Math.round(d)), (t = x.getLinearTickPositions(d, f, H));
                    else if (0.08 <= d) {
                        n = Math.floor(f);
                        var N, m;
                        for (
                            w = 0.3 < d ? [1, 2, 4] : 0.15 < d ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9];
                            n < H + 1 && !m;
                            n++
                        ) {
                            var b = w.length;
                        ...
                        (f = this.lin2log(f)),
                            (H = this.lin2log(H)),
                            (d = C ? x.getMinorTickInterval() : n.tickInterval),
                            (d = K(
                                'auto' === d ? null : d,
                                this.minorAutoInterval,
                                ((n.tickPixelInterval / (C ? 5 : 1)) * (H - f)) /
                                    ((C ? w / x.tickPositions.length : w) || 1),
                            )),
                            (d = M(d, void 0, q(d))),
                            (t = x.getLinearTickPositions(d, f, H).map(this.log2lin)),
            ...
            d.compose = function (d) {
                ...
                E(d, 'init', function (d) {
                    ...
                    'logarithmic' !== d.userOptions.type
                        ...
                        : (f || (f = this.logarithmic = new J(this)),
    ...
    Q(
        ...
        [A['parts/Globals.js'], A['parts/Axis.js'], A['parts/Utilities.js']],
        function (d, f, E) {
            var q = E.arrayMax,
                M = E.arrayMin,
                K = E.defined,
                ...
                D = (function () {
                    ...
                    f.prototype.render = function () {
                        ...
                        t.chart.styledMode ||
                            (I
                                ? ((G.stroke = S || '#999999'),
                                  (G['stroke-width'] = C(b.width, 1)),
                                  b.dashStyle && (G.dashstyle = b.dashStyle))
                                : l &&
                                  ((G.fill = S || '#e6ebf5'),
                                  b.borderWidth && ((G.stroke = b.borderColor), (G['stroke-width'] = b.borderWidth))));
                        c.zIndex = R;
                        k += '-' + R;
                        (m = t.plotLinesAndBandsGroups[k]) ||
                            (t.plotLinesAndBandsGroups[k] = m =
                                a
                                    .g('plot-' + k)
                                    .attr(c)
                                    .add());
                        ...
                        if (I)
                            G = t.getPlotLinePath({ value: p, lineWidth: u.strokeWidth(), acrossPanes: b.acrossPanes });
                        else if (l) G = t.getPlotBandPath(e, h, b);
                        else return;
                        (y || !u.d) && G && G.length
                            ? (u.attr({ d: G }),
                              B &&
                            ...
                            : u &&
                              (G
                                  ? (u.show(!0), u.animate({ d: G }))
                                  : u.d && (u.hide(), v && (f.label = v = v.destroy())));
                        g && (K(g.text) || K(g.formatter)) && G && G.length && 0 < t.width && 0 < t.height && !G.isFlat
                            ? ((g = F(
                                  {
                                      align: w && l && 'center',
                                      x: w ? !l && 4 : 10,
                    ...
                    f.prototype.renderLabel = function (d, f, w, m) {
                        ...
                        b ||
                            ...
                            (b.zIndex = m),
                            (m = this.getLabelText(d)),
                            (this.label = b = g.text(m, 0, 0, d.useHTML).attr(b).add()),
                            this.axis.chart.styledMode || b.css(d.style));
            ...
            m = (function () {
                ...
                b.prototype.bodyFormatter = function (b) {
                    return b.map(function (b) {
                        ...
                        return (g[(b.point.formatPrefix || 'point') + 'Formatter'] || b.point.tooltipFormatter).call(
                            b.point,
                            g[(b.point.formatPrefix || 'point') + 'Format'] || '',
                        );
                    });
                };
                ...
                b.prototype.getAnchor = function (b, d) {
                    ...
                    this.followPointer && d
                        ? ('undefined' === typeof d.chartX && (d = e.normalize(d)), (b = [d.chartX - m, d.chartY - l]))
                        : b[0].tooltipPos
                        ? (b = b[0].tooltipPos)
                        : (b.forEach(function (e) {
                          ...
                          (b = [
                              p ? g.plotWidth - f : u,
                              this.shared && !p && 1 < b.length && d ? d.chartY - l : p ? g.plotHeight - u : f,
                          ]));
                ...
                b.prototype.getLabel = function () {
                    var b,
                        ...
                        u =
                            (null === (b = l.style) || void 0 === b ? void 0 : b.pointerEvents) ||
                    ...
                    if (!this.label) {
                        this.outside &&
                            ((this.container = y = d.doc.createElement('div')),
                            (y.className = 'highcharts-tooltip-container'),
                            q(y, { position: 'absolute', top: '1px', pointerEvents: u, zIndex: 3 }),
                            d.doc.body.appendChild(y),
                            (this.renderer = e =
                                new d.Renderer(
                                    y,
                                    0,
                                    0,
                                    null === (m = this.chart.options.chart) || void 0 === m ? void 0 : m.style,
                                    void 0,
                                    void 0,
                                    e.styledMode,
                                )));
                        this.split
                            ? (this.label = e.g(f))
                            : ((this.label = e
                                  .label('', 0, 0, l.shape || 'callout', null, null, l.useHTML, null, f)
                ...
                b.prototype.getPosition = function (b, d, h) {
                    var e = this.chart,
                        ...
                        k = function (k) {
                            var l = 'x' === k;
                            return [k, l ? v : n, l ? b : d].concat(
                                f
                                    ? [
                                          l ? c(b) : a(d),
                                          l ? t.left - g + c(h.plotX + e.plotLeft) : t.top - g + a(h.plotY + e.plotTop),
                                          0,
                                          l ? v : n,
                                      ]
                                    : [
                                          l ? b : d,
                                          l ? h.plotX + e.plotLeft : h.plotY + e.plotTop,
                                          l ? e.plotLeft : e.plotTop,
                                          l ? e.plotLeft + e.plotWidth : e.plotTop + e.plotHeight,
                                      ],
                            );
                        },
                        r = k('y'),
                        ...
                        C = function (a, c, e, b, k) {
                            ...
                            k < g || k > c - g
                                ? (h = !1)
                                : (l[a] = k < e / 2 ? 1 : k > c - b / 2 ? c - b - 2 : k - e / 2);
                            return h;
                        },
                        q = function (a) {
                            var c = r;
                ...
                b.prototype.move = function (b, d, h, e) {
                    var g = this,
                        ...
                        m =
                            ...
                            !g.isHidden &&
                            (1 < Math.abs(b - l.x) || 1 < Math.abs(d - l.y)),
                ...
                b.prototype.refresh = function (b, d) {
                    ...
                    if (e.enabled) {
                        ...
                        d = n[0];
                        var t = n[1];
                        !l || (g.series && g.series.noSharedTooltip)
                            ? (l = g.getLabelConfig())
                            : (h.pointer.applyInactiveState(g),
                              g.forEach(function (e) {
                                  e.setState('hover');
                        ...
                        !1 === h
                            ? this.hide()
                            : (this.split
                                  ? this.renderSplit(h, w(b))
                                  : ((b = this.getLabel()),
                                    (e.style.width && !v) || b.css({ width: this.chart.spacingBox.width + 'px' }),
                                    b.attr({ text: h && h.join ? h.join('') : h }),
                                    b
                                        .removeClass(/highcharts-color-[\d]+/g)
                                        .addClass('highcharts-color-' + D(g.colorIndex, u.colorIndex)),
                                    v || b.attr({ stroke: e.borderColor || g.color || u.color || '#666666' }),
                                    this.updatePosition({
                                        plotX: d,
                                        plotY: t,
                                        negative: g.negative,
                ...
                b.prototype.renderSplit = function (b, m) {
                    function g(a, c, e, b, k) {
                        void 0 === k && (k = !0);
                        e
                            ? ((c = C ? 0 : F), (a = E(a - b / 2, x.left, x.right - b)))
                            : ((c -= T), (a = k ? a - b - r : a + r), (a = E(a, k ? a : x.left, x.right)));
                        return { x: a, y: c };
                    }
                    var e = this,
                        p = e.chart,
                    ...
                    b = b.slice(0, m.length + 1).reduce(function (c, b, l) {
                        if (!1 !== b && '' !== b) {
                            ...
                            p ||
                                ((p = { padding: z.padding, r: z.borderRadius }),
                                k || ((p.fill = z.backgroundColor), (p['stroke-width'] = z.borderWidth)),
                                (p = t
                                    .label(
                                        '',
                                        0,
                                        0,
                                        z[y ? 'headerShape' : 'shape'] || 'callout',
                                        void 0,
                                        void 0,
                                        z.useHTML,
                                    )
                                    .addClass((y ? 'highcharts-tooltip-header ' : '') + 'highcharts-tooltip-box ' + G)
                                    .attr(p)
                                    .add(q)));
                            p.isActive = !0;
                            p.attr({ text: b });
                            k ||
                                p
                                    .css(z.style)
                                    .shadow(z.shadow)
                                    .attr({ stroke: z.borderColor || l.color || n.color || '#333333' });
                            b = d.tt = p;
                            y = b.getBBox();
                            ...
                            if (l.isHeader) {
                                ...
                                (p = O.xAxis),
                                    (O = O.yAxis),
                                    (n = p.pos + E(n, -r, p.len + r)),
                                    O.pos + G >= a + v && O.pos + G <= a + v + f - B && (I = O.pos + G);
                            n = E(n, x.left - r, x.right + r);
                            'number' === typeof I
                                ? ((y = y.height + 1),
                                  (G = P ? P.call(e, d, y, l) : g(n, I, h, d)),
                                  c.push({
                                      align: P ? 0 : void 0,
                                      anchorX: n,
                                      anchorY: I,
                    ...
                    e.outside &&
                        ...
                        p &&
                        ((l = q.getBBox()),
                        p.setSize(l.width + l.x, l.height + l.y, !1),
                ...
                b.prototype.drawTracker = function () {
                    if (this.followPointer || !this.options.stickOnContact) this.tracker && this.tracker.destroy();
                        ...
                        if (d && h) {
                            ...
                            e.y = Math.min(0, h[1]);
                            e.width =
                                0 > h[0] ? Math.max(Math.abs(h[0]), p.width - h[0]) : Math.max(Math.abs(h[0]), p.width);
                            e.height =
                                0 > h[1]
                                    ? Math.max(Math.abs(h[1]), p.height - Math.abs(h[1]))
                                    : Math.max(Math.abs(h[1]), p.height);
                            this.tracker
                                ? this.tracker.attr(e)
                                : ((this.tracker = d.renderer.rect(e).addClass('highcharts-tracker').add(d)),
                ...
                b.prototype.tooltipFooterHeaderFormatter = function (b, d) {
                    ...
                    L(this, 'headerFormatter', d, function (h) {
                        ...
                        u &&
                            l &&
                            ((b.point && b.point.tooltipDateKeys) || ['key']).forEach(function (e) {
                ...
                b.prototype.updatePosition = function (b) {
                    ...
                    if (this.outside) {
                        ...
                        if ((g = g.containerScaling))
                            q(this.container, { transform: 'scale(' + g.scaleX + ', ' + g.scaleY + ')' }),
                                (d *= g.scaleX),
                                (l *= g.scaleY);
                        d += h.left - b.x;
                        l += h.top - b.y;
    ...
    Q(
        A,
        'parts/Pointer.js',
        [A['parts/Globals.js'], A['parts/Utilities.js'], A['parts/Tooltip.js'], A['parts/Color.js']],
        function (d, f, E, q) {
            var M = f.addEvent,
                K = f.attr,
                J = f.css,
            ...
            f = (function () {
                ...
                f.prototype.destroy = function () {
                    ...
                    d.chartCount ||
                        (d.unbindDocumentMouseUp && (d.unbindDocumentMouseUp = d.unbindDocumentMouseUp()),
                ...
                f.prototype.drag = function (b) {
                    ...
                    if (!c || !c.touch)
                        if (
                            (l < v ? (l = v) : l > v + t && (l = v + t),
                            g < n ? (g = n) : g > n + B && (g = n + B),
                            (this.hasDragged = Math.sqrt(Math.pow(a - l, 2) + Math.pow(k - g, 2))),
                            10 < this.hasDragged)
                        ) {
                            ...
                            e.hasCartesianSeries &&
                                ...
                                ((this.selectionMarker = c =
                                    e.renderer
                                        .rect(v, n, d ? 1 : t, f ? 1 : B, 0)
                                        .attr({ class: 'highcharts-selection-marker', zIndex: 7 })
                                        .add()),
                                e.styledMode ||
                                    c.attr({ fill: h.selectionMarkerFill || m('#335cad').setOpacity(0.25).get() }));
                ...
                f.prototype.drop = function (b) {
                    ...
                    if (this.selectionMarker) {
                        ...
                        if (this.hasDragged || l)
                            h.axes.forEach(function (c) {
                                ...
                                B &&
                                    H(h, 'selection', g, function (c) {
                                        h.zoom(x(c, l ? { animation: !1 } : null));
                                    });
                    ...
                    h &&
                        C(h.index) &&
                        (J(h.container, { cursor: h._cursor }),
                ...
                f.prototype.getChartCoordinatesFromPoint = function (b, e) {
                    ...
                    if (l && h)
                        return e
                            ? { chartX: l.len + l.pos - g, chartY: h.len + h.pos - b.plotY }
                            : { chartX: g + l.pos, chartY: b.plotY + h.pos };
                ...
                f.prototype.getHoverData = function (b, e, g, l, d, m) {
                    ...
                    f = f
                        ...
                        : g.filter(function (e) {
                              return u.filter
                                  ...
                                  : e.visible &&
                                        !(!d && e.directTouch) &&
                                        t(e.options.enableMouseTracking, !0) &&
                                        e.stickyTracking;
                          });
                    ...
                    return { hoverPoint: u.hoverPoint, hoverSeries: e, hoverPoints: p };
                };
                ...
                f.prototype.onTrackerMouseOut = function (b) {
                    ...
                    if (
                        !(
                            ...
                            (this.inClass(b, 'highcharts-series-' + e.index) && this.inClass(b, 'highcharts-tracker'))
                        )
                    )
                        e.onMouseOut();
                };
                ...
                f.prototype.onContainerClick = function (b) {
                    ...
                    var l = e.plotLeft,
                        h = e.plotTop;
                    e.cancelClick ||
                        (g && this.inClass(b.target, 'highcharts-tracker')
                            ? (H(g.series, 'click', x(b, { point: g })), e.hoverPoint && g.firePointEvent('click', b))
                            : (x(b, this.getCoordinates(b)),
                              e.isInsidePlot(b.chartX - l, b.chartY - h) && H(e, 'click', b)));
                };
                ...
                f.prototype.pinch = function (b) {
                    var e = this,
                        ...
                        B =
                            1 === m &&
                            ((e.inClass(b.target, 'highcharts-tracker') && h.runTrackerClick) || e.runChartClick),
                        c = {};
                    1 < m && (e.initiated = !0);
                    ...
                    'touchstart' === b.type
                        ? ([].forEach.call(d, function (a, c) {
                              l[c] = { chartX: a.chartX, chartY: a.chartY };
                          }),
                          ...
                          (e.res = !0))
                        : e.followTouchMove && 1 === m
                        ? this.runPointActions(e.normalize(b))
                        : l.length &&
                          (n || (e.selectionMarker = n = x({ destroy: g, touch: !0 }, h.plotBox)),
                          e.pinchTranslate(l, d, w, n, c, f),
                          (e.hasPinched = v),
                          e.scaleGroups(w, c),
                ...
                f.prototype.pinchTranslateDirection = function (b, e, g, l, d, m, f, v) {
                    ...
                    V
                        ? ((I -= 0.8 * (I - f[p][0])), 'number' === typeof O && (O -= 0.8 * (O - f[p][1])), g())
                        : (f[p] = [I, O]);
                    n || ((m[p] = z - k), (m[a] = r));
                    m = n ? 1 / y : y;
                    d[a] = r;
                            ...
                            m.shared && h
                                ? h.forEach(function (e) {
                                      ...
                                      e.series.isCartesian &&
                                          (e.series.xAxis.crosshair && e.series.xAxis.drawCrosshair(null, e),
                                          e.series.yAxis.crosshair && e.series.yAxis.drawCrosshair(null, e));
                                  })
                                : d &&
                ...
                f.prototype.runPointActions = function (g, e) {
                    ...
                    y = this.getHoverData(
                        ...
                        y,
                        h.series,
                        (!g || 'touchmove' !== g.type) && (!!e || (y && y.directTouch && this.isDirectTouch)),
                        m,
                        g,
                    );
                    f = y.hoverPoint;
                    ...
                    if (f && (f !== h.hoverPoint || (l && l.isHidden))) {
                        ...
                        e &&
                            l &&
                            !l.isHidden &&
                            ((f = l.getAnchor([{}], g)), l.updatePosition({ plotX: f[0], plotY: f[1] }));
                    this.unDocMouseMove ||
                        (this.unDocMouseMove = M(h.container.ownerDocument, 'mousemove', function (e) {
                    ...
                    h.axes.forEach(function (e) {
                        var b = t((e.crosshair || {}).snap, !0),
                            l;
                        b &&
                            (((l = h.hoverPoint) && l.series[e.coll] === e) ||
                                (l = F(v, function (c) {
                ...
                f.prototype.scaleGroups = function (b, e) {
                    ...
                    g.series.forEach(function (d) {
                        ...
                        d.xAxis &&
                            ...
                            d.group &&
                            (d.group.attr(l),
                            d.markerGroup && (d.markerGroup.attr(l), d.markerGroup.clip(e ? g.clipRect : null)),
                            d.dataLabelsGroup && d.dataLabelsGroup.attr(l));
                    });
                ...
                f.prototype.setDOMEvents = function () {
                    ...
                    d.unbindDocumentMouseUp ||
                        (d.unbindDocumentMouseUp = M(e, 'mouseup', this.onDocumentMouseUp.bind(this)));
                    d.hasTouch &&
                        (M(b, 'touchstart', this.onContainerTouchStart.bind(this)),
                        M(b, 'touchmove', this.onContainerTouchMove.bind(this)),
                        d.unbindDocumentTouchEnd ||
                            (d.unbindDocumentTouchEnd = M(e, 'touchend', this.onDocumentTouchEnd.bind(this))));
                };
                ...
                f.prototype.touch = function (b, e) {
                    ...
                    if (1 === b.touches.length)
                        if (
                            ((b = this.normalize(b)),
                            (l = g.isInsidePlot(b.chartX - g.plotLeft, b.chartY - g.plotTop)) && !g.openMenu)
                        ) {
                            ...
                            if ('touchmove' === b.type) {
                                ...
                                var d = e[0]
                                    ? 4 <=
                                      Math.sqrt(
                                          Math.pow(e[0].chartX - b.chartX, 2) + Math.pow(e[0].chartY - b.chartY, 2),
                                      )
                                    : !1;
                            }
                            t(d, !0) && this.pinch(b);
    ...
    Q(
        A,
        'parts/MSPointer.js',
        [A['parts/Globals.js'], A['parts/Pointer.js'], A['parts/Utilities.js']],
        function (d, f, E) {
            function q() {
                var d = [];
                d.item = function (d) {
                ...
                x(w, function (f) {
                    d.push({ pageX: f.pageX, pageY: f.pageY, target: f.target });
                });
                return d;
            }
            function M(f, n, m, b) {
                ('touch' !== f.pointerType && f.pointerType !== f.MSPOINTER_TYPE_TOUCH) ||
                    !H[d.hoverChartIndex] ||
                    (b(f),
                    (b = H[d.hoverChartIndex].pointer),
                    b[n]({ type: m, target: f.currentTarget, preventDefault: D, touches: q() }));
            }
            var K =
                    (this && this.__extends) ||
                    (function () {
            ...
            return (function (d) {
                ...
                f.prototype.onContainerPointerDown = function (d) {
                    M(d, 'onContainerTouchStart', 'touchstart', function (b) {
                        w[b.pointerId] = { pageX: b.pageX, pageY: b.pageY, target: b.currentTarget };
                    });
                };
    ...
    Q(A, 'parts/Legend.js', [A['parts/Globals.js'], A['parts/Utilities.js']], function (d, f) {
        ...
        var m = d.isFirefox,
            ...
            v = (function () {
                ...
                g.prototype.setOptions = function (e) {
                    ...
                    this.options = e;
                    this.chart.styledMode ||
                        ((this.itemStyle = e.itemStyle), (this.itemHiddenStyle = C(this.itemStyle, e.itemHiddenStyle)));
                ...
                g.prototype.positionItem = function (e) {
                    ...
                    d = d[1];
                    var m = e.checkbox;
                    if ((e = e.legendGroup) && e.element)
                        e[K(e.translateY) ? 'animate' : 'attr']({
                    ...
                    l.text &&
                        (this.title ||
                            ((this.title = this.chart.renderer
                                .label(l.text, g - 3, g - 4, null, null, null, b.useHTML, null, 'legend-title')
                                .attr({ zIndex: 1 })),
                            this.chart.styledMode || this.title.css(l.style),
                            this.title.add(this.group)),
                        l.width || this.title.css({ width: this.maxLegendWidth + 'px' }),
                ...
                g.prototype.renderItem = function (b) {
                    ...
                    c ||
                        ((b.legendGroup = g
                            ...
                            .addClass(
                                'highcharts-' +
                                    ...
                                    b.colorIndex +
                                    (t ? ' ' + t : '') +
                                    (a ? ' highcharts-series-' + b.index : ''),
                            )
                            .attr({ zIndex: 1 })
                            .add(this.scrollGroup)),
                        (b.legendItem = c = g.text('', w ? h + m : -m, this.baseline || 0, z)),
                        e.styledMode || c.css(C(b.visible ? f : v)),
                        c.attr({ align: w ? 'left' : 'right', zIndex: 2 }).add(b.legendGroup),
                        this.baseline ||
                            ((this.fontMetrics = g.fontMetrics(e.styledMode ? 12 : f.fontSize, c)),
                        ...
                        k.drawLegendSymbol(this, b),
                        this.setItemEvents && this.setItemEvents(b, c, z));
                    r && !b.checkbox && this.createCheckboxForItem && this.createCheckboxForItem(b);
                    this.colorizeItem(b, b.visible);
                    (!e.styledMode && f.width) ||
                        c.css({ width: (d.itemWidth || this.widthOption || e.spacingBox.width) - n + 'px' });
                    this.setText(b);
                    e = c.getBBox();
                ...
                g.prototype.layoutItem = function (b) {
                    ...
                    this.offsetWidth =
                        this.widthOption ||
                        Math.max((d ? this.itemX - g - (b.checkbox ? 0 : v) : e) + g, this.offsetWidth);
                };
                g.prototype.getAllItems = function () {
                    ...
                    this.chart.series.forEach(function (e) {
                        var g = e && e.options;
                        e &&
                            D(g.showInLegend, K(g.linkedTo) ? !1 : void 0, !0) &&
                            (b = b.concat(e.legendItems || ('point' === g.legendType ? e.data : e)));
                    });
                ...
                g.prototype.adjustMargins = function (e, g) {
                    var l = this.chart,
                        ...
                        h = this.getAlignment();
                    h &&
                        [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function (m, f) {
                            m.test(h) &&
                                !K(e[f]) &&
                                (l[b[f]] = Math.max(
                                    l[b[f]],
                                    l.legend[(f + 1) % 2 ? 'legendHeight' : 'legendWidth'] +
                                        [1, -1, -1, 1][f] * d[f % 2 ? 'x' : 'y'] +
                                        D(d.margin, 12) +
                                        g[f] +
                                        (l.titleOffset[f] || 0),
                ...
                g.prototype.proximatePositions = function () {
                    ...
                    this.allItems.forEach(function (e) {
                        ...
                        if (e.yAxis && e.points) {
                            ...
                            e.visible
                                ? ((h = h ? h.plotY : e.yAxis.height), (h += m - 0.3 * d))
                                : (h = m + e.yAxis.height);
                ...
                g.prototype.render = function () {
                    ...
                    l ||
                        ((this.group = l = g.g('legend').attr({ zIndex: 7 }).add()),
                        (this.contentGroup = g.g().attr({ zIndex: 1 }).add(l)),
                        (this.scrollGroup = g.g().add(this.contentGroup)));
                    this.renderTitle();
                    var v = this.getAllItems();
                    t(v, function (b, c) {
                        return (
                            ((b.options && b.options.legendIndex) || 0) - ((c.options && c.options.legendIndex) || 0)
                        );
                    });
                    ...
                    n += m;
                    d ||
                        ((this.box = d = g.rect().addClass('highcharts-legend-box').attr({ r: h.borderRadius }).add(l)),
                        (d.isNew = !0));
                    b.styledMode ||
                        d
                            .attr({
                    ...
                    0 < v &&
                        ...
                        (d[d.isNew ? 'attr' : 'animate'](
                            d.crisp.call({}, { x: 0, y: 0, width: v, height: n }, d.strokeWidth()),
                        ),
                        (d.isNew = !1));
                    d[f ? 'show' : 'hide']();
                ...
                g.prototype.handleOverflow = function (b) {
                    ...
                    var v = h.maxHeight,
                        ...
                        q = function (a) {
                            ...
                            e.contentGroup.div &&
                                (e.contentGroup.div.style.clip = a
                    ...
                    z.length = 0;
                    b > m && !1 !== c.enabled
                        ? ((this.clipHeight = n = Math.max(m - 20 - this.titleHeight - f, 0)),
                          ...
                          w || ((w = e.clipRect = d.clipRect(0, f, 9999, 0)), e.contentGroup.clip(w)),
                          q(n),
                          r ||
                              ((this.nav = r = d.g().attr({ zIndex: 1 }).add(this.group)),
                              (this.up = d.symbol('triangle', 0, 0, k, k).add(r)),
                              C('upTracker').on('click', function () {
                                  e.scroll(-1, a);
                              }),
                              (this.pager = d.text('', 15, 10).addClass('highcharts-legend-navigation')),
                              g.styledMode || this.pager.css(c.style),
                              this.pager.add(r),
                              (this.down = d.symbol('triangle-down', 0, 0, k, k).add(r)),
                              C('downTracker').on('click', function () {
                                  e.scroll(1, a);
                              })),
                          e.scroll(0),
                          (b = m))
                ...
                g.prototype.scroll = function (b, g) {
                    ...
                    0 < f &&
                        ...
                        d.styledMode ||
                            (this.up.attr({ fill: 1 === f ? p.inactiveColor : p.activeColor }),
                            this.upTracker.css({ cursor: 1 === f ? 'default' : 'pointer' }),
                            this.down.attr({ fill: f === m ? p.inactiveColor : p.activeColor }),
                            this.downTracker.css({ cursor: f === m ? 'default' : 'pointer' })),
                        (this.scrollOffset = -h[f - 1] + this.initialItemY),
                        this.scrollGroup.animate({ translateY: this.scrollOffset }),
                        (this.currentPage = f),
                        this.positionCheckboxes(),
                        (g = q(D(g, d.renderer.globalAnimation, !0))),
                        N(function () {
        ...
        (/Trident\/7\.0/.test(g.navigator && g.navigator.userAgent) || m) &&
            f(v.prototype, 'positionItem', function (b, e) {
                var g = this,
                    d = function () {
    ...
    Q(
        ...
        [
            A['parts/Globals.js'],
            A['parts/Legend.js'],
            A['parts/MSPointer.js'],
            A['parts/Pointer.js'],
            A['parts/Time.js'],
            A['parts/Utilities.js'],
        ],
        function (d, f, E, q, M, K) {
            var J = K.addEvent,
                L = K.animate,
                x = K.animObject,
                F = K.attr,
            ...
            N(aa.prototype, {
                ...
                redraw: function (a) {
                    ...
                    if (n) for (a = k.length; a--; ) (v = k[a]), v.options.stacking && (v.isDirty = !0);
                    k.forEach(function (a) {
                        a.isDirty &&
                            ('point' === a.options.legendType
                                ? (a.updateTotals && a.updateTotals(), (h = !0))
                                : l && (l.labelFormatter || l.labelFormat) && (h = !0));
                ...
                getChartSize: function () {
                    ...
                    this.chartHeight = Math.max(
                        0,
                        R(a, this.chartWidth) || (1 < this.containerHeight ? this.containerHeight : 400),
                    );
                },
                temporaryDisplay: function (a) {
                    ...
                    if (a)
                        for (; c && c.style; )
                            c.hcOrigStyle && (C(c, c.hcOrigStyle), delete c.hcOrigStyle),
                                c.hcOrigDetached && (z.body.removeChild(c), (c.hcOrigDetached = !1)),
                                (c = c.parentNode);
                    else
                        for (; c && c.style; ) {
                            z.body.contains(c) || c.parentNode || ((c.hcOrigDetached = !0), z.body.appendChild(c));
                            if ('none' === g(c, 'display', !1) || c.hcOricDetached)
                                (c.hcOrigStyle = {
                ...
                getContainer: function () {
                    ...
                    this.renderer = new (d[k.renderer] || d.Renderer)(
                        g,
                        u,
                        p,
                        null,
                ...
                reflow: function (a) {
                    ...
                    if (!d && !c.isPrinting && l && b && (e === A || e === z)) {
                        if (l !== c.containerWidth || b !== c.containerHeight)
                            K.clearTimeout(c.reflowTimeout),
                                (c.reflowTimeout = k(
                                    function () {
                ...
                setReflow: function (a) {
                    ...
                    !1 === a || this.unbindReflow
                        ...
                        : ((this.unbindReflow = J(A, 'resize', function (a) {
                ...
                setSize: function (a, e, g) {
                    ...
                    d.getChartSize();
                    d.styledMode ||
                        (g ? L : C)(d.container, { width: d.chartWidth + 'px', height: d.chartHeight + 'px' }, g);
                    d.setChartSize(!0);
                ...
                drawChartBox: function () {
                    ...
                    d ||
                        ((P = 'attr'),
                        (this.plotBackground = d = c.rect().addClass('highcharts-plot-background').add()));
                    d[P](w);
                    h ||
                        (d.attr({ fill: r || 'none' }).shadow(a.plotShadow),
                        u &&
                            (m
                                ? (u !== m.attr('href') && m.attr('href', u), m.animate(w))
                                : (this.plotBGImage = c.image(u, v, z, n, y).add())));
                    t ? t.animate({ width: B.width, height: B.height }) : (this.clipRect = c.clipRect(B));
                    P = 'animate';
                    l ||
                        ((P = 'attr'),
                        (this.plotBorder = l = c.rect().addClass('highcharts-plot-border').attr({ zIndex: 1 }).add()));
                ...
                updateContainerScaling: function () {
                    ...
                    if (a.offsetWidth && a.offsetHeight && a.getBoundingClientRect) {
                        ...
                        1 !== b || 1 !== a
                            ? (this.containerScaling = { scaleX: b, scaleY: a })
                ...
                firstRender: function () {
                    ...
                    if (!a.isReadyToRender || a.isReadyToRender()) {
                        ...
                        q &&
                            (a.pointer =
                                d.hasTouch || (!A.PointerEvent && !A.MSPointerEvent) ? new q(a, c) : new E(a, c));
                        a.render();
            ...
            if (!this.renderer.forExport) {
                if (x) {
                    if ((this.scrollablePixelsX = x = Math.max(0, x - this.chartWidth))) {
                        this.plotWidth += x;
                        this.inverted
                            ? ((this.clipBox.height += x), (this.plotBox.height += x))
                            : ((this.clipBox.width += x), (this.plotBox.width += x));
                        var F = { 1: { name: 'right', value: x } };
                    }
                } else
                    q &&
                        (this.scrollablePixelsY = x = Math.max(0, q - this.chartHeight)) &&
                        ((this.plotHeight += x),
                        this.inverted
                            ? ((this.clipBox.width += x), (this.plotBox.width += x))
                            : ((this.clipBox.height += x), (this.plotBox.height += x)),
                        (F = { 2: { name: 'bottom', value: x } }));
                F &&
                    !f.skipAxes &&
                ...
                ? ((this.fixedDiv = q(
                  ...
                  (this.fixedRenderer = L =
                      new d.Renderer(
                          ...
                          this.chartWidth,
                          this.chartHeight,
                          null === (f = this.options.chart) || void 0 === f ? void 0 : f.style,
                      )),
                  (this.scrollableMask = L.path()
                      .attr({
                          fill: this.options.chart.backgroundColor || '#fff',
                          'fill-opacity': A(F.opacity, 0.85),
                          zIndex: -1,
                      })
            ...
            J = (function () {
                ...
                d.prototype.resetStacks = function () {
                    ...
                    d.axis.isXAxis ||
                        A(f, function (f) {
                            A(f, function (q, x) {
                                q.touched < d.stacksTouched
                                    ? (q.destroy(), delete f[x])
        ...
        d.LegendSymbolMixin = {
            drawRectangle: function (d, f) {
                ...
                f.legendSymbol = this.chart.renderer
                    .rect(
                        A ? (d.symbolWidth - E) / 2 : 0,
                        d.baseline - E + 1,
                        A ? E : d.symbolWidth,
                        E,
                        q(d.options.symbolRadius, E / 2),
                    )
            ...
            drawLineMarker: function (d) {
                ...
                var D = {};
                this.chart.styledMode ||
                    ((D = { 'stroke-width': f.lineWidth || 0 }), f.dashStyle && (D.dashstyle = f.dashStyle));
                this.legendLine = H.path(['M', 0, d, 'L', L, d]).addClass('highcharts-graph').attr(D).add(C);
                A &&
                    !1 !== A.enabled &&
                    L &&
                    ((f = Math.min(q(A.radius, F), F)),
                    0 === this.symbol.indexOf('url') && ((A = E(A, { width: x, height: x })), (f = 0)),
                    (this.legendSymbol = A =
                        H.symbol(this.symbol, L / 2 - f, d - f, 2 * f, 2 * f, A)
                            .addClass('highcharts-point')
                            .add(C)),
                    (A.isMarker = !0));
            },
    ...
    Q(A, 'parts/Point.js', [A['parts/Globals.js'], A['parts/Utilities.js']], function (d, f) {
        ...
        f = (function () {
            ...
            d.prototype.animateBeforeDestroy = function () {
                ...
                f.plural.forEach(function (b) {
                    d[b].forEach(function (b) {
                        b.element &&
                            b.animate(K({ x: d.startXPos }, b.startYPos ? { x: b.startXPos, y: b.startYPos } : {}));
                    });
                });
            };
            d.prototype.applyOptions = function (f, b) {
                ...
                this.formatPrefix = (this.isNull = w(this.isValid && !this.isValid(), null === this.x || !H(this.y)))
                    ? 'null'
                    : 'point';
            ...
            d.prototype.optionsToObject = function (f) {
                ...
                if (H(f) || null === f) b[h[0]] = f;
                    ...
                    for (
                        !m &&
                        f.length > e &&
                        ((g = typeof f[0]), 'string' === g ? (b.name = f[0]) : 'number' === g && (b.x = f[0]), p++);
                        l < e;

                    )
                        (m && 'undefined' === typeof f[p]) ||
                            (0 < h[l].indexOf('.') ? d.prototype.setNestedProperty(b, f[p], h[l]) : (b[h[l]] = f[p])),
                            p++,
                            l++;
                else
                    'object' === typeof f &&
                        ((b = f), f.dataLabels && (g._hasPointLabels = !0), f.marker && (g._hasPointMarkers = !0));
                return b;
            };
            d.prototype.resolveColor = function () {
                ...
                d.options.colorByPoint
                    ? (g ||
                          ((b = d.options.colors || d.chart.options.colors),
                          (this.color = this.color || b[d.colorCounter]),
                          (b = b.length)),
                      (g = d.colorCounter),
                      d.colorCounter++,
                      d.colorCounter === b && (d.colorCounter = 0))
                    : (g = d.colorIndex);
    ...
    Q(
        A,
        'parts/Series.js',
        [A['mixins/legend-symbol.js'], A['parts/Globals.js'], A['parts/Point.js'], A['parts/Utilities.js']],
        function (d, f, A, q) {
            '';
            var E = q.addEvent,
                K = q.animObject,
                ...
                },
                {
                    ...
                    init: function (a, c) {
                        ...
                        e(f, function (a, c) {
                            b(a) &&
                                d.eventOptions[c] !== a &&
                                (b(d.eventOptions[c]) && l(d, c, d.eventOptions[c]),
                                (d.eventOptions[c] = a),
                                E(d, c, a));
                        });
                        ...
                        t(this, 'bindAxes', null, function () {
                            (a.axisTypes || []).forEach(function (d) {
                                b[d].forEach(function (b) {
                                    ...
                                    if (
                                        c[d] === e.index ||
                                        ('undefined' !== typeof c[d] && c[d] === e.id) ||
                                        ('undefined' === typeof c[d] && 0 === e.index)
                                    )
                    ...
                    autoIncrement: function () {
                        ...
                        e &&
                            ((a = new d.Date(c)),
                            'day' === e
                                ? d.set('Date', a, d.get('Date', a) + b)
                                : 'month' === e
                                ? d.set('Month', a, d.get('Month', a) + b)
                                : 'year' === e && d.set('FullYear', a, d.get('FullYear', a) + b),
                            (b = a.getTime() - c));
                        this.xIncrement = c + b;
                        return c;
                    },
                    ...
                    setOptions: function (a) {
                        ...
                        this.tooltipOptions = h(
                            G.tooltip,
                            G.plotOptions.series && G.plotOptions.series.tooltip,
                        ...
                        (!d.negativeColor && !d.negativeFillColor) ||
                            ...
                            c || ((e.color = d.negativeColor), (e.fillColor = d.negativeFillColor)),
                            b.push(e));
                        b.length &&
                            H(b[b.length - 1].value) &&
                    ...
                    getColor: function () {
                        this.chart.styledMode
                            ...
                            : this.getCyclic(
                                  'color',
                                  this.options.color || S[this.type].color,
                    ...
                    updateData: function (a, c) {
                        ...
                        a.forEach(function (a, c) {
                            var f = (H(a) && this.pointClass.prototype.optionsToObject.call({ series: this }, a)) || {};
                            var r = f.x;
                            if (f.id || g(r)) {
                                if (
                                    ((r = this.findPointIndex(f, h)),
                                    -1 === r || 'undefined' === typeof r
                                        ? k.push(a)
                                        : d[r] && a !== b.data[r]
                                        ? (d[r].update(a, !1, null, !1), (d[r].touched = !0), m && (h = r + 1))
                                        : d[r] && (d[r].touched = !0),
                                    !u || c !== r || (e && e.enabled) || this.hasDerivedData)
                                )
                                    l = !0;
                            } else k.push(a);
                        }, this);
                        if (l) for (a = d.length; a--; ) (f = d[a]) && !f.touched && f.remove && f.remove(!1, c);
                        else
                            !u || (e && e.enabled)
                                ? (p = !1)
                                : (a.forEach(function (a, c) {
                        ...
                        null === this.xIncrement &&
                            this.xData &&
                            this.xData.length &&
                            ((this.xIncrement = J(this.xData)), this.autoIncrement());
                        return !0;
                    },
                            ...
                            if (n && f > n)
                                ...
                                for (b = 0; b < f; b++)
                                    'undefined' !== typeof a[b] &&
                                        ((e = { series: d }),
                                        d.pointClass.prototype.applyOptions.apply(e, [a[b]]),
                                        d.updateParallelArrays(e, b));
                            w && v(w[0]) && D(14, !0, r);
                            d.data = [];
                    ...
                    sortData: function (a) {
                        var c = this,
                            ...
                            e = function (a, c) {
                                return (H(c) && a.pointClass.prototype.optionsToObject.call({ series: a }, c)) || {};
                            };
                    ...
                    getProcessedData: function (a) {
                        ...
                        for (l = c.length || 1; --l; )
                            if (
                                ((e = f ? a(c[l]) - a(c[l - 1]) : c[l] - c[l - 1]),
                                0 < e && ('undefined' === typeof y || e < y))
                            )
                                var y = e;
                    ...
                    generatePoints: function () {
                        ...
                        for (n = 0; n < l; n++) {
                            ...
                            if (m) {
                                ...
                                y.dataGroup.options &&
                                    ((y.options = y.dataGroup.options), w(y, y.dataGroup.options), delete y.dataLabels);
                            } else
                                (y = b[v]) ||
                                    'undefined' === typeof c[v] ||
                                    (b[v] = y = new f().init(this, c[v], d[n]));
                            y && ((y.index = v), (p[n] = y));
                        }
                        this.options.keys = a;
                        if (b && (l !== (e = b.length) || m))
                    ...
                    getExtremes: function (a, c) {
                        ...
                        for (p = 0; p < e; p++) {
                            ...
                            v =
                                ...
                                ((d[p + u] || v) >= f && (d[p - u] || v) <= h);
                            if (w && v)
                                if ((w = y.length)) for (; w--; ) g(y[w]) && (k[l++] = y[w]);
                                else k[l++] = y;
                        }
                        ...
                        for (n = 0; n < h; n++) {
                            var C = f[n],
                                ...
                                A =
                                    c &&
                                    l.stacking &&
                                    l.stacking.stacks[(this.negStacks && R < (B ? 0 : w) ? '-' : '') + this.stackKey];
                            ...
                            m(L) &&
                                ((S = L[0]),
                                (R = L[1]),
                                S === B && E.key === A[D].base && (S = p(g(w) && w, l.min)),
                                l.positiveValuesOnly && 0 >= S && (S = null),
                                (C.total = C.stackTotal = N.total),
                                (C.percentage = N.total && (C.y / N.total) * 100),
                                (C.stackY = R),
                            ...
                            C.plotY =
                                'number' === typeof R && Infinity !== R
                                    ? x(l.translate(R, 0, 1, 0, 1), -1e5, 1e5)
                                    : void 0;
                    ...
                    getValidPoints: function (a, c, b) {
                        ...
                        return (a || this.points || []).filter(function (a) {
                            return c && !e.isInsidePlot(a.plotX, a.plotY, e.inverted)
                                ? !1
                    ...
                    getClipBox: function (a, c) {
                        ...
                        a && !1 === b.clip && k
                            ? (a = d
                                  ...
                                  : { y: -k.pos, height: e.chartHeight, width: e.chartWidth, x: -g.pos })
                    ...
                    setClip: function (a) {
                        var c = this.chart,
                            ...
                            f =
                                this.sharedClipKey ||
                                ['_sharedClip', a && a.duration, a && a.easing, l.height, b.xAxis, b.yAxis].join(),
                            h = c[f],
                            m = c[f + 'm'];
                        a && ((l.width = 0), d && (l.x = c.plotHeight + (!1 !== b.clip ? 0 : c.plotTop)));
                        h
                            ? c.hasLoaded || h.attr(l)
                            : (a &&
                                  (c[f + 'm'] = m =
                                      e.clipRect(
                                          d ? c.plotSizeX + 99 : -99,
                        ...
                        if (!1 !== b.clip || a)
                            this.group.clip(a || g ? h : c.clipRect),
                    ...
                    animate: function (a) {
                        ...
                        if (!c.hasRendered)
                            if (a) this.setClip(b);
                                ...
                                a && a.animate(d, b);
                                c[e + 'm'] &&
                                    c[e + 'm'].animate({ width: d.width + 99, x: d.x - (c.inverted ? 0 : 99) }, b);
                            }
                    },
                    ...
                    drawPoints: function () {
                        ...
                        if (!1 !== d.enabled || this._hasPointMarkers)
                            for (b = 0; b < a.length; b++) {
                                ...
                                var n = !!h.marker;
                                if (
                                    ((l && 'undefined' === typeof u.enabled) || u.enabled) &&
                                    !h.isNull &&
                                    !1 !== h.visible
                                ) {
                                    ...
                                    var w = !1 !== h.isInside;
                                    e
                                        ? e[w ? 'show' : 'hide'](w).animate(y)
                                        : w &&
                                          (0 < y.width || h.hasImage) &&
                                          ((h.graphic = e =
                                              c.renderer.symbol(v, y.x, y.y, y.width, y.height, n ? u : d).add(g)),
                                          this.enabledDataSorting &&
                                              c.hasRendered &&
                                              (e.attr({ x: h.startXPos }), (m = 'animate')));
                    ...
                    markerAttribs: function (a, c) {
                        ...
                        c &&
                            ...
                            (k = p(c && c.radius, e && e.radius, k + ((e && e.radiusPlus) || 0))));
                    ...
                    drawGraph: function () {
                        ...
                        d.forEach(function (d, g) {
                            var k = d[0],
                                ...
                                l = f ? 'animate' : 'attr';
                            f
                                ? ((f.endX = a.preventGraphAnimation ? null : b.xMap), f.animate({ d: b }))
                                : b.length &&
                                  (a[k] = f = a.chart.renderer.path(b).addClass(d[1]).attr({ zIndex: 1 }).add(a.group));
                            f &&
                                !e &&
                                ((k = {
                                    stroke: d[2],
                                ...
                                d[3]
                                    ? (k.dashstyle = d[3])
                                    : 'square' !== c.linecap && (k['stroke-linecap'] = k['stroke-linejoin'] = 'round'),
                                f[l](k).shadow(2 > g && c.shadow));
                    ...
                    applyZones: function () {
                        ...
                        if (e.length && (h || m) && n && 'undefined' !== typeof n.min) {
                            ...
                            e.forEach(function (e, k) {
                                ...
                                t = Math.max(d, g);
                                n.isXAxis
                                    ? ((l = { x: v ? t : w, y: 0, width: y, height: u }),
                                      I || (l.x = c.plotHeight - l.x))
                                    : ((l = { x: 0, y: v ? t : w, width: u, height: y }),
                                      I && (l.y = c.plotWidth - l.y));
                                v &&
                                    b.isVML &&
                                    (l = n.isXAxis
                                        ? { x: 0, y: C ? w : t, height: l.width, width: c.chartWidth }
                                        : {
                    ...
                    plotGroup: function (a, c, b, e, d) {
                        ...
                        g.addClass(
                            'highcharts-' +
                                ...
                                this.type +
                                '-series ' +
                                (H(this.colorIndex) ? 'highcharts-color-' + this.colorIndex + ' ' : '') +
                                (this.options.className || '') +
                                (g.hasClass('highcharts-tracker') ? ' highcharts-tracker' : ''),
                            !0,
                        );
                        g.attr({ visibility: b })[k ? 'attr' : 'animate'](this.getPlotBox());
                        return g;
                    },
                    getPlotBox: function () {
                        var a = this.chart,
    ...
    Q(
        A,
        'parts/Stacking.js',
        [A['parts/Axis.js'], A['parts/Globals.js'], A['parts/StackingAxis.js'], A['parts/Utilities.js']],
        function (d, f, A, q) {
            ...
            var F = f.Series,
                H = (function () {
                    ...
                    d.prototype.render = function (d) {
                        ...
                        this.label
                            ? this.label.attr({ text: t, visibility: 'hidden' })
                            : ((this.label = f.renderer.label(
                              ...
                              f.styledMode ||
                                  ...
                                  (t.stroke = n.borderColor),
                                  (t['stroke-width'] = n.borderWidth),
                            ...
                            (g =
                                'left' === g
                                    ...
                                    ? n
                                        ...
                                        : -t
                                    : q.width / 2),
                            (n = b.inverted ? q.height / 2 : n ? -t : q.height),
                            (this.alignOptions.x = x(this.options.x, 0)),
                            (this.alignOptions.y = x(this.options.y, 0)),
                            (m.x -= g),
                            (m.y -= n),
                            f.align(this.alignOptions, null, m),
                            b.isInsidePlot(
                                f.alignAttr.x + g - this.alignOptions.x,
                                f.alignAttr.y + n - this.alignOptions.y,
                            )
                                ? f.show()
                                : ((f.alignAttr.y = -9999), (d = !1)),
                            d && F.prototype.justifyDataLabel.call(this.axis, f, this.alignOptions, f.alignAttr, q, m),
                            f.attr({ x: f.alignAttr.x, y: f.alignAttr.y }),
                            x(!d && this.options.crop, !0) &&
                                ((b = b.isInsidePlot(f.x - t + f.width, f.y) && b.isInsidePlot(f.x + t, f.y)) ||
                                    f.hide()));
                    };
            ...
            q.prototype.getStacks = function () {
                ...
                d.series.forEach(function (w) {
                    ...
                    !w.options.stacking ||
                        (!0 !== w.visible && !1 !== d.options.chart.ignoreHiddenSeries) ||
                        (w.stackKey = [
                            w.type,
                            x(w.options.stack, ''),
                            f ? n.top : n.left,
            ...
            F.prototype.setStackedPoints = function () {
                if (
                    ...
                    for (u = 0; u < n; u++) {
                        ...
                        p[B][y] ||
                            (l[B] && l[B][y]
                                ? ((p[B][y] = l[B][y]), (p[B][y].total = null))
                                : (p[B][y] = new H(e, e.options.stackLabels, I, y, b)));
                        B = p[B][y];
                        null !== G
                            ? ((B.points[R] = B.points[this.index] = [x(B.cumulative, m)]),
                              K(B.cumulative) || (B.base = R),
                              (B.touched = e.stacking.stacksTouched),
                              0 < S.index &&
                                  !1 === this.singleStacks &&
                                  (B.points[R][0] = B.points[this.index + ',' + y + ',0'][0]))
                            : (B.points[R] = B.points[this.index] = null);
                        'percent' === t
                            ? ((I = I ? g : v),
                              h && p[I] && p[I][y]
                                  ? ((I = p[I][y]), (B.total = I.total = Math.max(I.total, B.total) + Math.abs(G) || 0))
                                  : (B.total = E(B.total + (Math.abs(G) || 0))))
                            : (B.total = E(B.total + (G || 0)));
                ...
                d[q + 'Stacker'] &&
                    [f, '-' + f].forEach(function (f) {
                        for (var b = n.length, g, m; b--; )
                            if (
                                ((g = n[b]),
                                (t = d.getStackIndicator(t, g, d.index, f)),
                                (m = (g = w[f] && w[f][g]) && g.points[t.key]))
                            )
                                d[q + 'Stacker'](m, g, b);
                    });
            };
    ...
    Q(
        A,
        'parts/Dynamics.js',
        [A['parts/Globals.js'], A['parts/Point.js'], A['parts/Time.js'], A['parts/Utilities.js']],
        function (d, f, A, q) {
            var E = q.addEvent,
                K = q.animate,
                J = q.createElement,
            ...
            d.cleanRecursively = function (e, g) {
                var f = {};
                b(e, function (b, l) {
                    if (t(e[l], !0) && !e.nodeType && g[l])
                        (b = d.cleanRecursively(e[l], g[l])), Object.keys(b).length && (f[l] = b);
            ...
            C(q.prototype, {
                addSeries: function (b, e, d) {
                    ...
                    b &&
                        ((e = g(e, !0)),
                        D(l, 'addSeries', { options: b }, function () {
                            f = l.initSeries(b);
                            l.isDirtyLegend = !0;
                            l.linkSeries();
                ...
                addAxis: function (b, e, d, g) {
                    return this.createAxis(e ? 'xAxis' : 'yAxis', { axis: b, redraw: d, animation: g });
                },
                addColorAxis: function (b, e, d) {
                    return this.createAxis('colorAxis', { axis: b, redraw: e, animation: d });
                },
                ...
                showLoading: function (b) {
                    ...
                    f ||
                        ((e.loadingDiv = f =
                            J('div', { className: 'highcharts-loading highcharts-loading-hidden' }, null, e.container)),
                        (e.loadingSpan = J('span', { className: 'highcharts-loading-inner' }, null, f)),
                        E(e, 'redraw', h));
                    f.className = 'highcharts-loading';
                    e.loadingSpan.innerHTML = g(b, d.lang.loading, '');
                    e.styledMode ||
                        (L(f, C(l.style, { zIndex: 10 })),
                        L(e.loadingSpan, l.labelStyle),
                        e.loadingShown ||
                            (L(f, { opacity: 0, display: '' }),
                            K(f, { opacity: l.style.opacity || 0.5 }, { duration: l.showDuration || 0 })));
                    e.loadingShown = !0;
                    h();
                },
                ...
                update: function (f, l, h, p) {
                    ...
                    this.collectionsWithUpdate.forEach(function (a) {
                        if (f[a]) {
                            ...
                            e(f[a]).forEach(function (b, e) {
                                (e = (x(b.id) && u.get(b.id)) || u[a][c ? c[e] : e]) &&
                                    e.coll === a &&
                                    (e.update(b, !1), h && (e.touched = !0));
                                !e &&
                                    h &&
                                    u.collectionsWithInit[a] &&
                                    (u.collectionsWithInit[a][0].apply(
                                        u,
                                        [b].concat(u.collectionsWithInit[a][1] || []).concat([!1]),
                                    ).touched = !0);
                            });
                            h &&
                    ...
                    a &&
                        u.getSeriesOrderByLinks().forEach(function (a) {
                            a.chart && a.update({}, !1);
                        }, this);
                    ...
                    k || (n(w) && w !== u.chartWidth) || (n(c) && c !== u.chartHeight)
                        ? u.setSize(w, c, p)
                        : g(l, !0) && u.redraw(p);
            ...
            C(l.prototype, {
                addPoint: function (b, e, d, f, l) {
                    ...
                    var v = p.x;
                    var y = u.length;
                    if (this.requireSorting && v < u[y - 1]) for (n = !0; y && u[y - 1] > v; ) y--;
                    ...
                    d &&
                        (c[0] && c[0].remove
                            ? c[0].remove(!1)
                            : (c.shift(), this.updateParallelArrays(p, 'shift'), m.shift()));
                    !1 !== l && D(this, 'addPoint', { point: p });
                    this.isDirtyData = this.isDirty = !0;
                    e && a.redraw(f);
                },
                removePoint: function (b, e, d) {
                    var f = this,
                        l = f.data,
                        m = l[b],
                        c = f.points,
                ...
                update: function (b, e) {
                    ...
                    if (a && this.points) {
                        var w = f.options;
                        !1 === w.visible
                            ? ((t.graphic = 1), (t.dataLabel = 1))
                            : f._hasPointLabels ||
                              ((c = w.marker),
                              (k = w.dataLabels),
                              c && (!1 === c.enabled || 'symbol' in c) && (t.graphic = 1),
                              k && !1 === k.enabled && (t.dataLabel = 1));
                        this.points.forEach(function (a) {
                            a &&
                                a.series &&
                                (a.resolveColor(),
                                Object.keys(t).length && a.destroyElements(t),
                                !1 === w.showInLegend && a.legendItem && l.legend.destroyItem(a));
                        }, this);
                    }
                    b.zIndex !== h.zIndex &&
                        u.forEach(function (a) {
                            f[a] && f[a].attr({ zIndex: b.zIndex });
                        });
                    f.initialType = n;
                    l.linkSeries();
                    D(this, 'afterUpdate');
    ...
    Q(
        A,
        'parts/AreaSeries.js',
        [A['parts/Globals.js'], A['parts/Color.js'], A['mixins/legend-symbol.js'], A['parts/Utilities.js']],
        function (d, f, A, q) {
            var E = f.parse,
                K = q.objectEach,
                J = q.pick;
                ...
                { softThreshold: !1, threshold: 0 },
                {
                    ...
                    getGraphPath: function (d) {
                        ...
                        var v = function (f, h, p) {
                            ...
                            'undefined' !== typeof v &&
                                ...
                                n.push({ plotX: e, plotY: null === w ? g : D.getThreshold(w), doCurve: !1 }));
                        };
                        d = d || this.points;
                        ...
                        for (w = 0; w < d.length; w++) {
                            ...
                            if (!h || q)
                                q || v(w, w - 1, 'left'),
                                    (h && !x && q) || (t.push(d[w]), n.push({ x: w, plotX: e, plotY: p })),
                                    q || v(w, w + 1, 'right');
                        }
                        w = f.call(this, t, !0, !0);
                        n.reversed = !0;
                    ...
                    drawGraph: function () {
                        ...
                        this.zones.forEach(function (f, w) {
                            C.push([
                                'zone-area-' + w,
                                'highcharts-area highcharts-zone-area-' + w + ' ' + f.className,
                                f.color || d.color,
                                f.fillColor || q.fillColor,
                            ]);
                        });
                        C.forEach(function (x) {
                            var w = x[0],
                                ...
                                C = {};
                            n
                                ? ((n.endX = d.preventGraphAnimation ? null : f.xMap), n.animate({ d: f }))
                                : ((C.zIndex = 0),
                                  (n = d[w] = d.chart.renderer.path(f).addClass(x[1]).add(d.group)),
                                  (n.isArea = !0));
                            d.chart.styledMode || (C.fill = J(x[3], E(x[2]).setOpacity(J(q.fillOpacity, 0.75)).get()));
                            n[t](C);
                            n.startX = f.xMap;
            ...
            {},
            {
                getPointSpline: function (d, q, A) {
                    ...
                    if (
                        ...
                        D += F;
                        C > d && C > J
                            ? ((C = Math.max(d, J)), (D = 2 * J - C))
                            : C < d && C < J && ((C = Math.min(d, J)), (D = 2 * J - C));
                        D > A && D > J
                            ? ((D = Math.max(A, J)), (C = 2 * J - D))
                            : D < A && D < J && ((D = Math.min(A, J)), (C = 2 * J - D));
                        q.rightContX = x;
                        q.rightContY = D;
                    }
    ...
    Q(
        ...
        [A['parts/Globals.js'], A['mixins/legend-symbol.js'], A['parts/Utilities.js']],
        function (d, f, A) {
            A = A.seriesType;
            ...
            f(
                ...
                },
                {
                    ...
                    getColumnMetrics: function () {
                        ...
                        !1 === f.grouping
                            ? (v = 1)
                            : d.chart.series.forEach(function (e) {
                                  var f = e.yAxis,
                                      l = e.options;
                                  if (
                                      e.type === d.type &&
                                      (e.visible || !d.chart.options.chart.ignoreHiddenSeries) &&
                                      q.len === f.len &&
                                      q.pos === f.pos
                                  ) {
                                      if (l.stacking) {
                    ...
                    translate: function () {
                        ...
                        d.points.forEach(function (e) {
                            ...
                            L(e.options.pointWidth) &&
                                ((q = k = Math.ceil(e.options.pointWidth)), (a -= Math.round((q - p) / 2)));
                            e.barX = a;
                            e.pointWidth = q;
                            e.tooltipPos = f.inverted
                                ? [b.len + b.pos - f.plotLeft - t, m.len + m.pos - f.plotTop - (c || 0) - I - k / 2, w]
                                : [a + k / 2, t + b.pos - f.plotTop, w];
                    ...
                    pointAttribs: function (d, f) {
                        ...
                        f &&
                            d &&
                            ((d = H(n.states[f], (d.options.states && d.options.states[f]) || {})),
                            (f = d.brightness),
                            (g = d.color || ('undefined' !== typeof f && E(g).brighten(d.brightness).get()) || g),
                            (v = d[m] || v),
                            (h = d[b] || h),
                            (q = d.dashStyle || q),
                            (e = C(d.opacity, e)));
                        ...
                        d.points.forEach(function (g) {
                            ...
                            if (F(g.plotY) && null !== g.y) {
                                ...
                                d.enabledDataSorting &&
                                    (g.startXPos = d.xAxis.reversed ? -(b ? b.width : 0) : d.xAxis.width);
                                n ||
                                    ((g.graphic = n = x[g.shapeType](b).add(g.group || d.group)) &&
                                        d.enabledDataSorting &&
                                        f.hasRendered &&
                                        f.pointCount < m &&
                                        (n.attr({ x: g.startXPos }), (h = !0), (e = 'animate')));
                                if (n && h) n[e](H(b));
                                if (q.borderRadius) n[e]({ r: q.borderRadius });
                                f.styledMode ||
                                    n[e](d.pointAttribs(g, g.selected && 'select')).shadow(
                                        !1 !== g.allowShadow && q.shadow,
                                        null,
                    ...
                    animate: function (d) {
                        ...
                        if (d)
                            (b.scaleY = 0.001),
                                (d = J(q.toPixels(w.threshold), q.pos, q.pos + q.len)),
                                m ? (b.translateX = d - q.len) : (b.translateY = d),
                                f.clipBox && f.setClip(),
                                f.group.attr(b);
                        else {
        ...
        f(
            ...
            },
            {
                ...
                applyJitter: function () {
                    ...
                    f &&
                        this.points.forEach(function (A, x) {
        ...
        d.CenteredSeriesMixin = {
            getCenter: function () {
                ...
                d = [
                    q(C[0], '50%'),
                    q(C[1], '50%'),
                    q(w && 0 > w ? void 0 : d.size, '100%'),
                    q(n && 0 > n ? void 0 : d.innerSize || 0, '0%'),
                ];
                f.angular && (d[3] = 0);
                for (C = 0; 4 > C; ++C)
                    (w = d[C]),
                        (f = 2 > C || (2 === C && /%$/.test(w))),
                        (d[C] = M(w, [A, E, D, d[2]][C]) + (f ? x : 0));
                d[3] > d[2] && (d[3] = d[2]);
                return d;
            },
    ...
    Q(
        A,
        'parts/PieSeries.js',
        [A['parts/Globals.js'], A['mixins/legend-symbol.js'], A['parts/Point.js'], A['parts/Utilities.js']],
        function (d, f, A, q) {
            var E = q.addEvent,
                K = q.clamp,
                J = q.defined,
            ...
            D(
                ...
                },
                {
                    ...
                    animate: function (d) {
                        ...
                        d ||
                            f.forEach(function (d) {
                                ...
                                e &&
                                    f &&
                                    (e.attr({ r: H(d.startR, b.center && b.center[3] / 2), start: m, end: m }),
                                    e.animate({ r: f.r, start: f.start, end: f.end }, b.options.animation));
                            });
                    },
                    hasData: function () {
                    ...
                    updateTotals: function () {
                        ...
                        for (d = 0; d < n; d++)
                            (e = f[d]),
                                (e.percentage = 0 < b && (e.visible || !h) ? (e.y / b) * 100 : 0),
                                (e.total = b);
                    },
                    generatePoints: function () {
                    ...
                    getX: function (d, b, f) {
                        ...
                        return (
                            g[0] +
                            (b ? -1 : 1) * Math.cos(d) * (h + f.labelDistance) +
                            (0 < f.labelDistance ? (b ? -1 : 1) * this.options.dataLabels.padding : 0)
                        );
                    },
                    translate: function (d) {
                        ...
                        for (u = 0; u < y; u++) {
                            ...
                            t.tooltipPos = [d[0] + 0.7 * B, d[1] + 0.7 * c];
                            ...
                            t.labelPosition = {
                                ...
                                connectorPosition: {
                                    breakAt: { x: d[0] + B + Math.cos(x) * w, y: d[1] + c + Math.sin(x) * w },
                    ...
                    redrawPoints: function () {
                        ...
                        !l ||
                            d.shadowGroup ||
                            b.styledMode ||
                            (d.shadowGroup = f.g('shadow').attr({ zIndex: -1 }).add(d.group));
                        d.points.forEach(function (g) {
                            var m = {};
                            h = g.graphic;
                            if (!g.isNull && h) {
                                ...
                                g.delayedRendering
                                    ? (h.setRadialReference(d.center).attr(p).attr(n),
                                      b.styledMode || h.attr(e).attr({ 'stroke-linejoin': 'round' }).shadow(l, v),
                                      (g.delayedRendering = !1))
                                    : (h.setRadialReference(d.center),
                                      b.styledMode || F(!0, m, e),
                                      F(!0, m, p, n),
                                      h.animate(m));
                    ...
                    drawPoints: function () {
                        ...
                        this.points.forEach(function (b) {
                            ...
                            b.graphic ||
                                ((b.graphic = d[b.shapeType](b.shapeArgs).add(b.series.group)),
                ...
                },
                {
                    ...
                    setVisible: function (d, b) {
                        ...
                        b = H(b, e);
                        d !== f.visible &&
                            ((f.visible = f.options.visible = d = 'undefined' === typeof d ? !f.visible : d),
                            (m.options.data[m.data.indexOf(f)] = f.options),
                            ['graphic', 'dataLabel', 'connector', 'shadowGroup'].forEach(function (b) {
                                if (f[b]) f[b][d ? 'show' : 'hide'](!0);
                            }),
                            f.legendItem && h.legend.colorizeItem(f, d),
                            d || 'hover' !== f.state || f.setState(''),
                            e && (m.isDirty = !0),
                            b && h.redraw());
                    },
                    ...
                    haloPath: function (d) {
                        ...
                        return this.sliced || !this.visible
                            ? []
                            : this.series.chart.renderer.symbols.arc(b.x, b.y, b.r + d, b.r + d, {
                                  innerR: b.r - 1,
                                  start: b.start,
                                  end: b.end,
                              });
    ...
    Q(A, 'parts/DataLabels.js', [A['parts/Globals.js'], A['parts/Utilities.js']], function (d, f) {
        ...
        d.distribute = function (b, f, m) {
            ...
            for (
                b = b.map(function (b) {
                    return { size: b.size, targets: [b.target], align: D(b.align, 0.5) };
                });
                n;
                ...
                for (e = b.length; e--; )
                    (n = b[e]),
                        (u = (Math.min.apply(0, n.targets) + Math.max.apply(0, n.targets)) / 2),
                        (n.pos = M(u - n.size * n.align, 0, f - n.size));
                e = b.length;
                for (n = !1; e--; )
                    0 < e &&
                        ...
                        (b[e - 1].align = 0.5),
                        b[e - 1].pos + b[e - 1].size > f && (b[e - 1].pos = f - b[e - 1].size),
                        b.splice(e, 1),
                        (n = !0));
            }
            l.push.apply(l, v);
            ...
            b.some(function (b) {
                ...
                if (
                    b.targets.some(function () {
                        l[e].pos = b.pos + g;
                        if ('undefined' !== typeof m && Math.abs(l[e].pos - l[e].target) > m)
                            return (
                                l.slice(0, e + 1).forEach(function (b) {
                                    delete b.pos;
                                }),
                                (l.reducedLen = (l.reducedLen || f) - 0.1 * f),
                                l.reducedLen > 0.1 * f && d.distribute(l, f, m),
                                !0
                            );
                        g += l[e].size;
                        e++;
        ...
        N.prototype.drawDataLabels = function () {
            ...
            function d(c, a) {
                ...
                else if (F(c) || F(a)) for (e = Math.max(c.length, a.length); e--; ) b[e] = H(c[e], a[e]);
                else b = H(c, a);
                return b;
            }
            var f = this,
            ...
            m = d(
                d(
                    ...
                    h.options.plotOptions && h.options.plotOptions[f.type] && h.options.plotOptions[f.type].dataLabels,
                ),
                m,
            );
                ...
                E &&
                    ...
                    u ||
                        setTimeout(function () {
                            ...
                            c &&
                                (f.visible && B.show(!0),
                                c[e.animation ? 'animate' : 'attr']({ opacity: 1 }, { duration: w }));
                        }, t - w));
                l.forEach(function (c) {
                    ...
                    q.forEach(function (a, d) {
                        ...
                        if (g) {
                            ...
                            var v = a.rotation;
                            h.styledMode ||
                                ((u.color = D(a.color, u.color, f.color, '#000000')),
                                'contrast' === u.color
                                    ? ((c.contrastColor = J.getContrast(c.color || f.color)),
                                      (u.color =
                                          (!K(m) && a.inside) || 0 > m || e.stacking ? c.contrastColor : '#000000'))
                                    : delete c.contrastColor,
                                e.cursor && (u.cursor = e.cursor));
                            var q = { r: a.borderRadius || 0, rotation: v, padding: a.padding, zIndex: 1 };
                            h.styledMode ||
                                ((q.fill = a.backgroundColor),
                                (q.stroke = a.borderColor),
                                (q['stroke-width'] = a.borderWidth));
                            C(q, function (a, c) {
                            ...
                            ? g &&
                              ...
                              (l
                                  ...
                                  : ((c.dataLabels = c.dataLabels || []),
                                    (l = c.dataLabels[d] =
                                        v
                                            ? J.text(p, 0, -9999, a.useHTML).addClass('highcharts-data-label')
                                            : J.label(p, 0, -9999, a.shape, null, null, a.useHTML, null, 'data-label')),
                                    d || (c.dataLabel = l),
                                    l.addClass(
                              ...
                              (l.options = a),
                              l.attr(q),
                              h.styledMode || l.css(u).shadow(a.shadow),
                              l.added || l.add(B),
                              a.textPath &&
                                  !a.useHTML &&
                                  (l.setTextPath(
                              ...
                              f.alignDataLabel(c, l, a, null, n))
                            : ((c.dataLabel = c.dataLabel && c.dataLabel.destroy()),
                              c.dataLabels &&
                                  (1 === c.dataLabels.length ? delete c.dataLabels : delete c.dataLabels[d]),
                              d || delete c.dataLabel,
                              k &&
                                  ((c.connector = c.connector.destroy()),
                                  c.connectors &&
                                      (1 === c.connectors.length ? delete c.connectors : delete c.connectors[d])));
                    });
                });
            }
        ...
        N.prototype.alignDataLabel = function (b, d, f, h, e) {
            var g = this,
                ...
                k =
                    ...
                    (b.series.forceDL ||
                        (n && !a) ||
                        c ||
                        (f.inside && h && l.isInsidePlot(q, m ? h.x + 1 : h.y + h.height - 1, m)));
            var r = function (f) {
            ...
            if (k) {
                ...
                h = J(
                    { x: m ? this.yAxis.len - v : q, y: Math.round(m ? this.xAxis.len - q : v), width: 0, height: 0 },
                    h,
                );
                J(f, { width: t.width, height: t.height });
                w
                    ? ((a = !1),
                      (q = l.renderer.rotCorr(z, w)),
                      (q = {
                          x: h.x + f.x + h.width / 2 + q.x,
                          y: h.y + f.y + { top: 0, middle: 0.5, bottom: 1 }[f.verticalAlign] * h.height,
                      }),
                      r(q),
                      d[e ? 'attr' : 'animate'](q).attr({ align: x }),
                      (r = (w + 720) % 360),
                      (r = 180 < r && 360 > r),
                      'left' === x
                          ? (q.y -= r ? t.height : 0)
                          : 'center' === x
                          ? ((q.x -= t.width / 2), (q.y -= t.height / 2))
                          : 'right' === x && ((q.x -= t.width), (q.y -= r ? 0 : t.height)),
                      (d.placed = !0),
                      (d.alignAttr = q))
                    : (r(h), d.align(f, null, h), (q = d.alignAttr));
                a && 0 <= h.height
                    ? this.justifyDataLabel(d, f, q, t, h, e)
                    : D(f.crop, !0) && (k = l.isInsidePlot(q.x, q.y) && l.isInsidePlot(q.x + t.width, q.y + t.height));
                if (f.shape && !w)
                    d[e ? 'attr' : 'animate']({
        ...
        N.prototype.setDataLabelStartPos = function (b, d, f, h, e) {
            ...
            d.startYPos = e;
            h
                ? 'hidden' === d.visibility && (d.show(), d.attr({ opacity: 0 }).animate({ opacity: 1 }))
        ...
        N.prototype.justifyDataLabel = function (b, d, f, h, e, m) {
            ...
            v = f.x + h.width - q;
            v > g.plotWidth &&
                ('left' === n ? ((d.align = 'right'), (d.inside = !0)) : (d.x = g.plotWidth - v), (t = !0));
            v = f.y + q;
            0 > v && ('bottom' === p ? ((d.verticalAlign = 'top'), (d.inside = !0)) : (d.y = -v), (t = !0));
            v = f.y + h.height - q;
            v > g.plotHeight &&
                ('top' === p ? ((d.verticalAlign = 'bottom'), (d.inside = !0)) : (d.y = g.plotHeight - v), (t = !0));
        ...
        m.pie &&
                            ...
                            (a.visible
                                ? (A[a.half].push(a),
                                  ...
                                  !K(e.style.width) &&
                                      ...
                                      a.dataLabel.getBBox().width > w &&
                                      (a.dataLabel.css({ width: Math.round(0.7 * w) + 'px' }),
                        ...
                        if (l) {
                            ...
                            if (0 < b.maxLabelDistance) {
                                ...
                                f.forEach(function (a) {
                                    0 < a.labelDistance &&
                                        a.dataLabel &&
                                        ((a.top = Math.max(0, c - B - a.labelDistance)),
                                        (a.bottom = Math.min(c + B + a.labelDistance, h.plotHeight)),
                            ...
                            for (J = 0; J < l; J++) {
                                ...
                                p &&
                                    K(m.distributeBox) &&
                                    ('undefined' === typeof m.distributeBox.pos
                                        ? (L = 'hidden')
                                        : ((z = m.distributeBox.size), (F = Q.radialDistributionY(m))));
                                ...
                                a._pos = {
                                    x: E + D(O.x, e.x) + ({ left: n, right: -n }[r.alignment] || 0),
                                    y: F + D(O.y, e.y) - 10,
                                };
                                r.final.x = E;
                                r.final.y = F;
                                D(e.crop, !0) &&
                                    ...
                                    (v = null),
                                    E - k < n && 1 === g
                                        ? ((v = Math.round(k - E + n)), (M[3] = Math.max(v, M[3])))
                                        : E + k > t - n &&
                                          0 === g &&
                                          ((v = Math.round(E + k - t + n)), (M[1] = Math.max(v, M[1]))),
                                    0 > F - z / 2
                                        ? (M[0] = Math.max(Math.round(-F + z / 2), M[0]))
                                        : F + z / 2 > u && (M[2] = Math.max(Math.round(F + z / 2 - u), M[2])),
                                    (a.sideOverflow = v));
                            }
                        }
                    }),
                    0 === q(M) || this.verifyDataLabelOverflow(M)) &&
            ...
            (m.pie.prototype.alignDataLabel = f),
            (m.pie.prototype.verifyDataLabelOverflow = function (b) {
                var d = this.center,
                    ...
                    m = null !== f.size;
                if (!m) {
                    if (null !== h[0]) var l = Math.max(d[2] - Math.max(b[1], b[3]), e);
                    else (l = Math.max(d[2] - b[1] - b[3], e)), (d[0] += (b[3] - b[1]) / 2);
                    null !== h[1]
                        ? (l = M(l, e, d[2] - Math.max(b[0], b[2])))
                        : ((l = M(l, e, d[2] - b[0] - b[2])), (d[1] += (b[0] - b[2]) / 2));
                    l < d[2]
                        ? ((d[2] = l),
                          (d[3] = Math.min(w(f.innerSize || 0, l), l)),
                          this.translate(d),
        ...
        m.column &&
            (m.column.prototype.alignDataLabel = function (b, d, f, h, e) {
                ...
                m &&
                    ...
                    (m = h.y + h.height - l.yAxis.len),
                    0 < m && m < h.height && (h.height -= m),
                    g &&
                        (h = {
        ...
        A(d, 'render', function () {
            ...
            (this.yAxis || []).forEach(function (f) {
                f.stacking &&
                    ...
                    K(f.stacking.stacks, function (f) {
                        K(f, function (f) {
                            d.push(f.label);
                        });
                    });
            ...
            (this.series || []).forEach(function (f) {
                ...
                f.visible &&
                    (!1 !== q.enabled || f._hasPointLabels) &&
                    (f.nodes || f.points).forEach(function (f) {
                        f.visible &&
                            (M(f.dataLabels) ? f.dataLabels : f.dataLabel ? [f.dataLabel] : []).forEach(function (q) {
                                var x = q.options;
            ...
            var t = function (b) {
                ...
                if (b && (!b.alignAttr || b.placed)) {
                    ...
                    b.width ||
                        ...
                        (b.width = d.width),
                        (b.height = d.height),
                        (d = E.fontMetrics(null, b.element).h));
                    var n = b.width - 2 * f;
                    (e = { left: '0', center: '0.5', right: '1' }[b.alignValue])
                        ? (h = +e * n)
                        : Math.round(b.x) !== b.translateX && (h = b.x - b.translateX);
                    return {
            ...
            for (D = 0; D < A; D++) {
                ...
                for (C = D + 1; C < A; ++C) {
                    ...
                    !J ||
                        ...
                        m.y > J.y + J.height ||
                        m.y + m.height < J.y ||
                        ((t.labelrank < w.labelrank ? t : w).newOpacity = 0);
                }
            }
                ...
                if (b) {
                    ...
                    b.oldOpacity !== d &&
                        (b.alignAttr && b.placed
                            ? (b[d ? 'removeClass' : 'addClass']('highcharts-data-label-hidden'),
                              (n = !0),
    ...
    Q(
        ...
        [A['parts/Globals.js'], A['parts/Legend.js'], A['parts/Point.js'], A['parts/Utilities.js']],
        function (d, f, A, q) {
            var E = q.addEvent,
                K = q.createElement,
                J = q.css,
            ...
            var p = (d.TrackerMixin = {
                drawTrackerPoint: function () {
                    ...
                    b._hasTracking ||
                        (b.trackerGroups.forEach(function (l) {
                            if (b[l]) {
                                b[l]
                                ...
                                !d.styledMode && b.options.cursor && b[l].css(J).css({ cursor: b.options.cursor });
                            }
                        }),
                        (b._hasTracking = !0));
                ...
                drawTrackerGraph: function () {
                    var b = this,
                        ...
                        k = 'rgba(192,192,192,' + (e ? 0.0001 : 0.002) + ')';
                    c
                        ? c.attr({ d: h })
                        : b.graph &&
                          ((b.tracker = p
                              ...
                              .addClass(f ? 'highcharts-tracker-area' : 'highcharts-tracker-line')
                              .add(b.group)),
                          m.styledMode ||
                              b.tracker.attr({
            ...
            x(f.prototype, {
                ...
                createCheckboxForItem: function (b) {
                    ...
                    E(b.checkbox, 'click', function (d) {
                        F(b.series || b, 'checkboxClick', { checked: d.target.checked, item: b }, function () {
                            b.select();
                        });
                    });
                },
                ...
                showResetZoom: function () {
                    ...
                    F(this, 'beforeShowResetZoom', null, function () {
                        d.resetZoomButton = d.renderer
                            .button(e.resetZoom, null, null, b, g, h && h.hover)
                            .attr({ align: f.position.align, title: e.resetZoomTitle })
                            .addClass('highcharts-reset-zoom')
                            .add()
                            .align(f.position, !1, n);
                    });
                        ...
                        c.forEach(function (a) {
                            ...
                            c.series.forEach(function (b) {
                                if (y && !a && (!x || x.isDirty)) {
                                    ...
                                    D(b.dataMin) &&
                                        D(b.dataMax) &&
                                        ((x.startMin = Math.min(b.dataMin, x.startMin)),
                                        (x.startMax = Math.max(b.dataMax, x.startMax)));
                                }
                            });
                            u = Math.min(
                                d.pick(null === x || void 0 === x ? void 0 : x.startMin, t.dataMin),
                                q ? t.min : c.toValue(c.toPixels(t.min) - c.minPixelPadding),
                            );
                            q = Math.max(
                                d.pick(null === x || void 0 === x ? void 0 : x.startMax, t.dataMax),
                                q ? t.max : c.toValue(c.toPixels(t.max) + c.minPixelPadding),
                            );
                            c.panningState = x;
                            if (!e.ordinal) {
                                e = u - p;
                                ...
                                e = v - q;
                                0 < e && ((v = q), (p -= e));
                                if ((c.series.length && p !== t.min && v !== t.max && a) || (x && p >= u && v <= q))
                                    c.setExtremes(p, v, !1, !1, { trigger: 'pan' }),
                                        f.resetZoomButton ||
                                            h ||
                                            !n.match('y') ||
                                            (f.showResetZoom(), (c.displayBtn = !1)),
                                        (m = !0);
                                f[g] = l;
                            }
                        });
                        ...
                        d ||
                            g.getSelectedPoints().forEach(function (b) {
                                ...
                                b.selected &&
                                    ...
                                    b.setState(g.hoverPoints && d.options.inactiveOtherPoints ? 'inactive' : ''),
                ...
                setState: function (d, e) {
                    ...
                    if (
                        !(
                            ...
                            !1 === l.enabled ||
                            (d && (c || (m && !1 === n.enabled))) ||
                            (d && k.states && k.states[d] && !1 === k.states[d].enabled)
                        )
                    ) {
                        this.state = d;
                            ...
                            if (!p.styledMode) {
                                ...
                                f.options.inactiveOtherPoints &&
                                    ...
                                    ((this.dataLabels || []).forEach(function (a) {
                                        a && a.animate({ opacity: w.opacity }, A);
                                    }),
                                    this.connector && this.connector.animate({ opacity: w.opacity }, A));
                            ...
                            if (d && n) {
                                ...
                                if (t)
                                    if (a) a[e ? 'animate' : 'attr']({ x: t.x, y: t.y });
                                        ...
                                        g &&
                                            ((f.stateMarkerGraphic = a =
                                                p.renderer.symbol(g, t.x, t.y, t.width, t.height).add(f.markerGroup)),
                                            (a.currentSymbol = g));
                        ...
                        d && d.size && a && 'hidden' !== l && !this.isCluster
                            ? (q || (f.halo = q = p.renderer.path().add(a.parentGroup)),
                              q.show()[e ? 'animate' : 'attr']({ d: this.haloPath(d.size) }),
                              q.attr({
                                  class:
                                      'highcharts-halo highcharts-color-' +
                                      N(this.colorIndex, f.colorIndex) +
                              ...
                              (q.point = this),
                              p.styledMode ||
                                  q.attr(x({ fill: this.color || f.color, 'fill-opacity': d.opacity }, d.attributes)))
                            : q && q.point && q.point.haloPath && q.animate({ d: q.point.haloPath(0) }, null, q.hide);
            ...
            x(v.prototype, {
                ...
                setState: function (b, d) {
                    ...
                    if (
                        ...
                        if (g && !g.dashstyle)
                            for (h = { 'stroke-width': m }, g.animate(h, a); e['zone-graph-' + f]; )
                                e['zone-graph-' + f].attr(h), (f += 1);
                        l ||
                            [e.group, e.markerGroup, e.dataLabelsGroup, e.labelBySeries].forEach(function (b) {
                                b && b.animate({ opacity: c }, a);
                            });
                    }
    ...
    Q(A, 'parts/Responsive.js', [A['parts/Globals.js'], A['parts/Utilities.js']], function (d, f) {
        ...
        d.prototype.setResponsive = function (d, f) {
            ...
            w = w.toString() || void 0;
            w !== (n && n.ruleIds) &&
                (n && this.update(n.undoOptions, d, !0),
                w
                    ? ((n = this.currentOptions(f)),
                      (n.isResponsiveOptions = !0),
                      (this.currentResponsive = { ruleIds: w, mergedOptions: f, undoOptions: n }),
                      this.update(f, d, !0))
        ...
        d.prototype.matchResponsiveRule = function (d, f) {
            ...
            (
                ...
                function () {
                    return (
                        this.chartWidth <= L(q.maxWidth, Number.MAX_VALUE) &&
                        this.chartHeight <= L(q.maxHeight, Number.MAX_VALUE) &&
                        this.chartWidth >= L(q.minWidth, 0) &&
                        this.chartHeight >= L(q.minHeight, 0)
                    );
                }
            ...
            function f(d, t, w, m) {
                ...
                J(d, function (d, n) {
                    if (!m && -1 < A.collectionsWithUpdate.indexOf(n))
                        for (d = x(d), w[n] = [], b = 0; b < d.length; b++)
                            t[n][b] && ((w[n][b] = {}), f(d[b], t[n][b], w[n][b], m + 1));
                    else
                        M(d)
                            ? ((w[n] = q(d) ? [] : {}), f(d, t[n] || {}, w[n], m + 1))
                            : (w[n] = 'undefined' === typeof t[n] ? null : t[n]);
                });
            }
            var A = this,
                w = {};
