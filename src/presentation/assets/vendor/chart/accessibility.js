...
(function (v) {
    ...
    r(
        a,
        'modules/accessibility/utils/htmlUtilities.js',
        [a['parts/Utilities.js'], a['parts/Globals.js']],
        function (a, f) {
            function h(a) {
                return a
                    .replace(/&/g, '&amp;')
    ...
    r(
        a,
        'modules/accessibility/utils/chartUtilities.js',
        [a['modules/accessibility/utils/htmlUtilities.js'], a['parts/Utilities.js']],
        function (a, f) {
            function h(a) {
            ...
            function n(a, d) {
                ...
                d !== a.renderTo &&
                    d.parentNode &&
                    (Array.prototype.forEach.call(d.parentNode.childNodes, function (c) {
            ...
            return {
                ...
                getSeriesFromName: function (a, d) {
                    return d
                        ? (a.series || []).filter(function (c) {
                              return c.name === d;
                          })
                        : a.series;
                },
                ...
                scrollToPoint: function (a) {
                    var d = a.series.xAxis,
                        c = a.series.yAxis,
                        b = (null === d || void 0 === d ? 0 : d.scrollbar) ? d : c;
                    if ((d = null === b || void 0 === b ? void 0 : b.scrollbar) && t(d.to) && t(d.from)) {
                        c = d.to - d.from;
                        if (t(b.dataMin) && t(b.dataMax)) {
                            var g = b.toPixels(b.dataMin),
                                m = b.toPixels(b.dataMax);
                            a = (b.toPixels(a['xAxis' === b.coll ? 'x' : 'y'] || 0) - g) / (m - g);
                        } else a = 0;
                        d.updatePosition(a - c / 2, a + c / 2);
                        v.fireEvent(d, 'changed', { from: d.from, to: d.to, trigger: 'scrollbar', DOMEvent: null });
                    }
                },
            };
        },
        ...
        h.prototype = {
            run: function (a) {
                var h = a.which || a.keyCode,
                    ...
                    t = q(this.keyCodeMap, function (a) {
                        return -1 < a[0].indexOf(h);
                    });
                t ? (e = t[1].call(this, h, a)) : 9 === h && (e = this.response[a.shiftKey ? 'prev' : 'next']);
                return e;
            },
        };
        return h;
    ...
    r(
        a,
        'modules/accessibility/utils/EventProvider.js',
        [a['parts/Globals.js'], a['parts/Utilities.js']],
        function (a, f) {
            var h = f.addEvent;
            f = f.extend;
            var l = function () {
    ...
    r(
        a,
        'modules/accessibility/utils/DOMElementProvider.js',
        [a['parts/Globals.js'], a['parts/Utilities.js'], a['modules/accessibility/utils/htmlUtilities.js']],
        function (a, f, q) {
    ...
    r(
        a,
        'modules/accessibility/AccessibilityComponent.js',
        [
            a['parts/Globals.js'],
            a['parts/Utilities.js'],
            a['modules/accessibility/utils/htmlUtilities.js'],
            a['modules/accessibility/utils/chartUtilities.js'],
            a['modules/accessibility/utils/EventProvider.js'],
            a['modules/accessibility/utils/DOMElementProvider.js'],
        ],
        function (a, f, q, l, n, e) {
            function h() {}
            var p = a.win,
                k = p.document;
            a = f.extend;
            var d = f.fireEvent,
                c = f.merge,
                b = q.removeElement,
                g = q.getFakeMouseEvent,
                m = l.unhideChartElementFromAT;
            h.prototype = {
                initBase: function (b) {
                    this.chart = b;
                ...
                getElementPosition: function (b) {
                    ...
                    return (b = this.chart.renderTo) && c && c.getBoundingClientRect
                        ? ((c = c.getBoundingClientRect()),
                          ...
                          { x: c.left - b.left, y: c.top - b.top, width: c.right - c.left, height: c.bottom - c.top })
                ...
                cloneMouseEvent: function (b) {
                    if ('function' === typeof p.MouseEvent) return new p.MouseEvent(b.type, b);
                    if (k.createEvent) {
        ...
        function (a, f, q, l) {
            ...
            h.prototype = {
                init: function (c, b) {
                    ...
                    d.addEvent(c.renderTo, 'mousedown', function () {
                        a.isClickingChart = !0;
                    });
                ...
                update: function (c) {
                    ...
                    b && b.enabled && c && c.length
                        ? ((this.modules = c.reduce(function (b, c) {
                ...
                onKeydown: function (c) {
                    c = c || e.event;
                    var b,
                        a = this.modules && this.modules.length && this.modules[this.currentModuleIx];
                    this.keyboardReset = !1;
                    if (a) {
                        var d = a.run(c);
                        d === a.response.success
                            ? (b = !0)
                            : d === a.response.prev
                            ? (b = this.prev())
                            : d === a.response.next && (b = this.next());
                ...
                createExitAnchor: function () {
                    var c = this.chart,
                        b = (this.exitAnchor = t.createElement('div'));
                ...
                addExitAnchorEventsToEl: function (c) {
                    ...
                    this.eventProvider.addEvent(c, 'focus', function (c) {
                        c = c || e.event;
                        (c.relatedTarget && b.container.contains(c.relatedTarget)) || a.exiting
                            ? (a.exiting = !1)
                            : (b.renderTo.focus(),
                              c.preventDefault(),
                              a.modules &&
                                  a.modules.length &&
                                  ((a.currentModuleIx = a.modules.length - 1),
                                  (c = a.modules[a.currentModuleIx]) && c.validate && !c.validate()
                                      ? a.prev()
                                      : c && c.init(-1)));
                    });
                },
                destroy: function () {
                    this.removeExitAnchor();
                    this.eventProvider.removeAddedEvents();
                    '0' === this.chart.container.getAttribute('tabindex') &&
    ...
    r(
        a,
        'modules/accessibility/components/LegendComponent.js',
        [
            a['parts/Globals.js'],
            a['parts/Legend.js'],
            a['parts/Utilities.js'],
            a['modules/accessibility/AccessibilityComponent.js'],
            a['modules/accessibility/KeyboardNavigationHandler.js'],
            a['modules/accessibility/utils/htmlUtilities.js'],
        ],
        function (a, f, q, l, n, e) {
            var h = q.addEvent,
            ...
            p(a.prototype, {
                ...
                updateLegendItemProxyVisibility: function () {
                    ...
                    (b.allItems || []).forEach(function (d) {
                        var g = d.pageIx || 0,
                            m = d._legendItemPos ? d._legendItemPos[1] : 0,
                ...
                updateProxies: function () {
                    ...
                    var b = this.chart,
                        a = b.legend && b.legend.allItems,
                        d = b.options.legend.accessibility || {};
                    !a ||
                        !a.length ||
                        (b.colorAxis && b.colorAxis.length) ||
                        !1 === d.enabled ||
                        (this.addLegendProxyGroup(), this.proxyLegendItems(), this.updateLegendItemProxyVisibility());
                },
                ...
                proxyLegendItem: function (b) {
                    var c = this,
                        a = this.chart.langFormat('accessibility.legend.legendItem', {
                            chart: this.chart,
                            itemName: d(b.name),
                        });
                    b.a11yProxyElement = this.createProxyButton(
                        b.legendItem,
                        this.legendProxyGroup,
                        { tabindex: -1, 'aria-pressed': !b.visible, 'aria-label': a },
                        b.legendGroup.div ? b.legendItem : b.legendGroup,
                        function () {
                ...
                onKbdArrowKey: function (b, c) {
                    ...
                    return g.highlightLegendItem(this.highlightedLegendItemIx + c)
                        ? ((this.highlightedLegendItemIx += c), d.success)
                        : 1 < u && e.keyboardNavigation.wrapAround
                        ? (b.init(c), d.success)
                        : d[0 < c ? 'next' : 'prev'];
                },
    ...
    r(
        a,
        'modules/accessibility/components/MenuComponent.js',
        [
            a['parts/Globals.js'],
            a['parts/Utilities.js'],
            a['modules/accessibility/AccessibilityComponent.js'],
        ...
        function (a, f, q, l, n, e) {
            ...
            f = f.extend;
            var p = n.unhideChartElementFromAT,
                k = e.removeElement,
                d = e.getFakeMouseEvent;
            ...
            f(a.prototype, {
                ...
                onChartRender: function () {
                    var c = this.chart,
                        b = c.options.accessibility;
                    k(this.exportProxyGroup);
                    var a = c.options.exporting,
                        d = h(c);
                    a &&
                        !1 !== a.enabled &&
                        a.accessibility &&
                ...
                onKbdPrevious: function (c) {
                    ...
                    return a.keyboardNavigation.wrapAround ? (b.highlightLastExportItem(), c.success) : c.prev;
                },
    ...
    r(
        a,
        'modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js',
        [
            a['parts/Globals.js'],
            a['parts/Point.js'],
            a['parts/Utilities.js'],
        ...
        function (a, f, q, l, n, e) {
                ...
                if (!e(b)) {
                    for (; w--; ) {
                        ...
                        if (
                            !e(u) &&
                            ((u =
                                (b.plotX - u.plotX) * (b.plotX - u.plotX) * (a || 1) +
                                (b.plotY - u.plotY) * (b.plotY - u.plotY) * (d || 1)),
                            u < g)
                        ) {
                            g = u;
                            var z = w;
            ...
            a.Chart.prototype.highlightAdjacentPoint = function (b) {
                ...
                if (a) {
                    if (
                        ((c = c[a.series.index + (b ? 1 : -1)]),
                        (d = m[d + (b ? 1 : -1)]),
                        !d && c && (d = c.points[b ? 0 : c.points.length - 1]),
                        !d)
                    )
                        return !1;
            ...
            a.Chart.prototype.highlightAdjacentSeries = function (b) {
                ...
                if (!this.highlightedPoint)
                    return (
                        ...
                        (g = b ? c && c.points && c.points[0] : g) ? g.highlight() : !1
                    );
                c = this.series[a.series.index + (b ? -1 : 1)];
                if (!c) return !1;
                g = d(a, c, 4);
                if (!g) return !1;
                if (p(c)) return g.highlight(), (b = this.highlightAdjacentSeries(b)), b ? b : (a.highlight(), !1);
                g.highlight();
            ...
            a.Chart.prototype.highlightAdjacentPointVertical = function (b) {
                ...
                this.series.forEach(function (g) {
                    p(g) ||
                        g.points.forEach(function (w) {
                            if (m(w.plotY) && m(w.plotX) && w !== c) {
                                var e = w.plotY - c.plotY,
                                    x = Math.abs(w.plotX - c.plotX);
                ...
                onHandlerInit: function (b, a) {
                    ...
                    if (0 < a) c(d);
                        ...
                        for (
                            ...
                            (g = d.series[a].highlightFirstValidPoint()));
    ...
    r(
        a,
        'modules/accessibility/components/AnnotationsA11y.js',
        [a['parts/Utilities.js'], a['modules/accessibility/utils/htmlUtilities.js']],
        function (a, f) {
            function h(a) {
            ...
            function l(a) {
                var c,
                    ...
                    m,
                    e =
                        null === (b = null === (c = a.options) || void 0 === c ? void 0 : c.accessibility) ||
                        void 0 === b
                            ? void 0
                            : b.description;
                return e
                    ? e
                    : (null === (m = null === (d = a.graphic) || void 0 === d ? void 0 : d.text) || void 0 === m
                          ? void 0
                          : m.textStr) || '';
            }
            function n(a) {
                ...
                a =
                    ...
                    (1 < m ? 'MultiplePoints' : m ? 'SinglePoint' : 'NoPoints');
            ...
            var t = a.inArray,
                p = f.escapeStringForHTML,
                k = f.stripHTMLTagsFromString;
            return {
    ...
    r(
        a,
        'modules/accessibility/components/SeriesComponent/SeriesDescriber.js',
        [
            a['parts/Utilities.js'],
            a['modules/accessibility/components/AnnotationsA11y.js'],
            a['modules/accessibility/utils/htmlUtilities.js'],
            a['modules/accessibility/utils/chartUtilities.js'],
            a['parts/Tooltip.js'],
        ],
        function (a, f, q, l, n) {
            function e(b) {
                var c = b.index;
                return b.series && b.series.data && F(c)
            ...
            function c(b) {
                ...
                return (
                    (c && b.chart.langFormat('accessibility.series.description', { description: c, series: b })) || ''
                );
            }
            function b(b, c) {
            ...
            function g(b) {
                ...
                if (c.xAxis && c.xAxis.dateTime)
                    return (
                        (c = n.prototype.getXDateFormat.call(
                            { getDateFormat: n.prototype.getDateFormat, chart: a },
                            b,
                            a.options.tooltip,
                            c.xAxis,
                        )),
                ...
                (c || a) &&
                    b.points.forEach(function (b) {
                        ...
                        if (
                            ...
                            g = g
                                ? { x: y(b.plotX, g.plotX, 0), y: y(b.plotY, g.plotY, 0) }
                            ...
                            d && d.element
                                ? ((b.graphic = g),
                                  (b.hasDummyGraphic = !0),
                                  g.add(d),
                                  d.element.insertBefore(g.element, a ? a.element : null),
                                  (a = g.element))
                                : (a = void 0);
                        }
                        a &&
                            ...
                            c
                                ? ((g = b.series),
                                  (d = g.chart.options.accessibility.point || {}),
                                  (g = g.options.accessibility || {}),
                                  (b = G(
                                      H(
                                          (g.pointDescriptionFormatter && g.pointDescriptionFormatter(b)) ||
            ...
            function v(a) {
                ...
                return (
                    (d.langFormat('accessibility.series.summary.' + a.type + g, y) ||
                        d.langFormat('accessibility.series.summary.default' + g, y)) +
                    (m ? ' ' + m : '') +
                    (e('yAxis') ? ' ' + k : '') +
                    (e('xAxis') ? ' ' + w : '')
                );
            ...
            var C = a.find,
                ...
                G = q.escapeStringForHTML,
                K = q.reverseChildNodes,
                H = q.stripHTMLTagsFromString,
                J = l.getAxisDescription,
                L = l.getSeriesFirstPointElement,
                M = l.getSeriesA11yElement,
            ...
            return {
                describeSeries: function (b) {
                    ...
                    if (d) {
                        ...
                        (c.options3d && c.options3d.enabled && a) || !(a || g || m || h(b))
                            ? d.setAttribute('aria-label', '')
                            : ((c = b.chart.options.accessibility),
                              (a = c.landmarkVerbosity),
                              (b.options.accessibility || {}).exposeAsGroupOnly
                                  ? d.setAttribute('role', 'img')
                                  : 'all' === a && d.setAttribute('role', 'region'),
                              d.setAttribute('tabindex', '-1'),
                              (d.style.outline = '0'),
                              d.setAttribute(
                                  'aria-label',
                                  G(H((c.series.descriptionFormatter && c.series.descriptionFormatter(b)) || v(b))),
                              ));
                    }
                },
    ...
    r(
        a,
        'modules/accessibility/utils/Announcer.js',
        [
            a['parts/Globals.js'],
            a['modules/accessibility/utils/DOMElementProvider.js'],
            a['modules/accessibility/utils/htmlUtilities.js'],
    ...
    r(
        a,
        'modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js',
        [
            a['parts/Globals.js'],
            a['parts/Utilities.js'],
            a['modules/accessibility/utils/chartUtilities.js'],
            a['modules/accessibility/components/SeriesComponent/SeriesDescriber.js'],
            a['modules/accessibility/utils/Announcer.js'],
            a['modules/accessibility/utils/EventProvider.js'],
        ],
        function (a, f, q, l, n, e) {
            function h(b) {
            ...
            var k = f.extend,
                d = f.defined,
                c = q.getChartTitle,
                b = l.defaultPointDescriptionFormatter,
            ...
            k(f.prototype, {
                ...
                onSeriesAdded: function (b) {
                    this.chart.options.accessibility.announceNewData.enabled &&
                        ...
                        (this.dirty.newSeries = d(this.dirty.newSeries) ? void 0 : b));
                },
                onPointAdded: function (b) {
                    var c = b.series.chart;
                    this.chart === c &&
                        c.options.accessibility.announceNewData.enabled &&
                        (this.dirty.newPoint = d(this.dirty.newPoint) ? void 0 : b);
                },
                ...
                queueAnnouncement: function (b, c, a) {
                    var d = this,
                        g = this.chart.options.accessibility.announceNewData;
                    if (g.enabled) {
                        var e = +new Date();
                        g = Math.max(0, g.minAnnounceInterval - (e - this.lastAnnouncementTime));
                        b = p(this.queuedAnnouncement && this.queuedAnnouncement.series, b);
                        if ((c = this.buildAnnouncementMessage(b, c, a)))
                            this.queuedAnnouncement && clearTimeout(this.queuedAnnouncementTimer),
                                (this.queuedAnnouncement = { time: e, message: c, series: b }),
                ...
                buildAnnouncementMessage: function (d, e, k) {
                    var m = this.chart,
                        f = m.options.accessibility.announceNewData;
                    if (f.announcementFormatter && ((d = f.announcementFormatter(d, e, k)), !1 !== d))
    ...
    r(
        a,
        'modules/accessibility/components/SeriesComponent/forcedMarkers.js',
        [a['parts/Globals.js'], a['parts/Utilities.js']],
        function (a, f) {
            function h(a) {
            ...
            return function () {
                l(a.Series, 'render', function () {
                    var a = this.options,
                        f = this.chart.options.accessibility.enabled,
                        p = !1 !== (this.options.accessibility && this.options.accessibility.enabled);
                    var k = this.chart.options.accessibility;
                    k =
                        this.points.length < k.series.pointDescriptionEnabledThreshold ||
                        !1 === k.series.pointDescriptionEnabledThreshold;
                    var d = this.chart.options.accessibility.keyboardNavigation.seriesNavigation;
                    d =
                        this.points.length < d.pointNavigationEnabledThreshold ||
                        !1 === d.pointNavigationEnabledThreshold;
                    if (f && p && (k || d)) {
                        if (
                            (a.marker && !1 === a.marker.enabled && ((this.a11yMarkersForced = !0), h(this.options)),
                            this._hasPointMarkers && this.points && this.points.length)
                        )
                            for (a = this.points, f = a.length; f--; )
                                (p = a[f].options),
                                    p.marker &&
                                        (p.marker.enabled
                                            ? n(!0, p.marker, {
                                                  states: {
                                                      normal: {
                                                          opacity:
                                                              (p.marker.states &&
                                                                  p.marker.states.normal &&
                                                                  p.marker.states.normal.opacity) ||
                                                              1,
                                                      },
                                                  },
                                              })
                                            : h(p));
                    } else this.a11yMarkersForced && this.resetMarkerOptions && (delete this.a11yMarkersForced, (a = this.resetA11yMarkerOptions), n(!0, this.options, { marker: { enabled: a.enabled, states: { normal: { opacity: a.states && a.states.normal && a.states.normal.opacity } } } }));
                });
    ...
    r(
        a,
        'modules/accessibility/components/SeriesComponent/SeriesComponent.js',
        [
            a['parts/Globals.js'],
            a['parts/Utilities.js'],
            a['modules/accessibility/AccessibilityComponent.js'],
            a['modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js'],
            a['modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js'],
            a['modules/accessibility/components/SeriesComponent/forcedMarkers.js'],
            a['modules/accessibility/utils/chartUtilities.js'],
            a['modules/accessibility/components/SeriesComponent/SeriesDescriber.js'],
            a['parts/Tooltip.js'],
        ],
        function (a, f, q, l, n, e, t, p, k) {
            f = f.extend;
            var d = t.hideSeriesFromAT,
                c = p.describeSeries;
    ...
    r(
        a,
        'modules/accessibility/components/ZoomComponent.js',
        [
            a['parts/Globals.js'],
            a['parts/Utilities.js'],
            a['modules/accessibility/AccessibilityComponent.js'],
        ...
        function (a, f, q, l, n, e) {
            ...
            a.Axis.prototype.panStep = function (b, c) {
                ...
                0 > b && d < c.dataMin
                    ? ((d = c.dataMin), (a = d + g))
                    : 0 < b && a > c.dataMax && ((a = c.dataMax), (d = a - g));
            ...
            h(a.prototype, {
                ...
                setMapNavButtonAttrs: function (b, c) {
                    ...
                    d(b, { tabindex: -1, role: 'button', 'aria-label': c });
                },
                onChartRender: function () {
                            ...
                            [
                                ...
                                function (b, c) {
                                    return this.response[
                                        (b === d.tab && c.shiftKey) || b === d.left || b === d.up ? 'prev' : 'next'
                                    ];
                                },
                            ],
                            [
    ...
    r(
        a,
        'modules/accessibility/components/RangeSelectorComponent.js',
        [
            a['parts/Globals.js'],
            a['parts/Utilities.js'],
            a['modules/accessibility/AccessibilityComponent.js'],
        ...
        function (a, f, q, l, n, e) {
            ...
            a.Chart.prototype.highlightRangeSelectorButton = function (a) {
                ...
                return d[a]
                    ? (this.setFocusToElement(d[a].box, d[a].element),
                      (this.oldRangeSelectorItemState = d[a].state),
                      d[a].setState(2),
                      !0)
                    : !1;
            };
            ...
            f(a.prototype, {
                onChartUpdate: function () {
                    ...
                    c &&
                        ...
                        c.maxInput &&
                            c.minInput &&
                            ['minInput', 'maxInput'].forEach(function (b, g) {
                                if ((b = c[b]))
                                    h(a, b),
                                        d.setRangeInputAttrs(
                                            b,
                                            'accessibility.rangeSelector.' + (g ? 'max' : 'min') + 'InputLabel',
                                        );
                            }));
                },
                ...
                onButtonNavKbdArrowKey: function (a, d) {
                    ...
                    return g.highlightRangeSelectorButton(g.highlightedRangeSelectorItemIx + d)
                        ? c.success
                        : e
                        ? (a.init(d), c.success)
                        : c[0 < d ? 'next' : 'prev'];
                ...
                onButtonNavKbdClick: function (a) {
                    a = a.response;
                    var d = this.chart;
                    3 !== d.oldRangeSelectorItemState &&
                        this.fakeClickEvent(d.rangeSelector.buttons[d.highlightedRangeSelectorItemIx].element);
                    return a.success;
                },
    ...
    r(
        a,
        'modules/accessibility/components/InfoRegionsComponent.js',
        [
            a['parts/Globals.js'],
            a['parts/Utilities.js'],
            a['modules/accessibility/AccessibilityComponent.js'],
        ...
        function (a, f, q, l, n, e, t) {
            ...
            var k = a.win.document,
                ...
                c = f.format,
                b = f.pick,
                g = n.getAnnotationsInfoHTML,
                m = e.unhideChartElementFromAT,
                r = e.getChartTitle,
                A = e.getAxisDescription,
                B = t.addClass,
                u = t.setElAttrs,
                z = t.escapeStringForHTML,
                v = t.stripHTMLTagsFromString,
                C = t.getElement,
            ...
            d(f.prototype, {
                ...
                defaultBeforeChartFormatter: function () {
                    ...
                    var m = 'hc-linkto-highcharts-data-table-' + c.index,
                        p = g(c),
                        ...
                        (c.onclick = function (b) {
                            ...
                            (
                                (null === (a = d.options.accessibility) || void 0 === a
                                    ? void 0
                                    : a.screenReaderSection.onPlayAsSoundClick) || g
                            ).call(this, b, d);
                        }));
                },
                initDataTableButton: function (b) {
                    ...
                    a &&
                        (u(a, { role: 'button', tabindex: '-1', 'aria-expanded': !!C(b), href: '#' + b }),
                        (a.onclick =
    ...
    r(
        a,
        'modules/accessibility/components/ContainerComponent.js',
        [
            a['parts/Globals.js'],
            a['parts/Utilities.js'],
            a['modules/accessibility/utils/htmlUtilities.js'],
        ...
        function (a, f, q, l, n) {
            ...
            a = f.extend;
            var h = q.stripHTMLTagsFromString,
                p = l.unhideChartElementFromAT,
                k = l.getChartTitle;
            q = function () {};
            q.prototype = new n();
            a(q.prototype, {
                ...
                handleSVGTitleElement: function () {
                    var a = this.chart,
                        c = 'highcharts-title-' + a.index,
                        b = h(a.langFormat('accessibility.svgContainerTitle', { chartTitle: k(a) }));
                    if (b.length) {
                        var g = (this.svgTitleElement =
                            this.svgTitleElement || e.createElementNS('http://www.w3.org/2000/svg', 'title'));
                        g.textContent = b;
                        g.id = c;
                ...
                setSVGContainerLabel: function () {
                    var a = this.chart,
                        c = h(a.langFormat('accessibility.svgContainerLabel', { chartTitle: k(a) }));
                    a.renderer.box && c.length && a.renderer.box.setAttribute('aria-label', c);
                },
                setGraphicContainerAttrs: function () {
                    var a = this.chart,
                        c = a.langFormat('accessibility.graphicContainerLabel', { chartTitle: k(a) });
                    ...
                    c &&
                        (c.textStr &&
                            c.element.setAttribute(
                                'aria-label',
                                h(a.langFormat('accessibility.credits', { creditsStr: c.textStr })),
                            ),
                        p(a, c.element));
                },
                destroy: function () {
            ...
            setHighContrastTheme: function (a) {
                ...
                a.series.forEach(function (a) {
                    ...
                    a.points.forEach(function (a) {
                        a.options &&
                            a.options.color &&
                            a.update({ color: f.color || 'windowText', borderColor: f.borderColor || 'window' }, !1);
                    });
                });
                a.redraw();
            },
    ...
    r(a, 'modules/accessibility/options/deprecatedOptions.js', [a['parts/Utilities.js']], function (a) {
        ...
        function l(a, c, b, g) {
            ...
            Object.keys(g).forEach(function (d) {
                var m = e[d];
                'undefined' !== typeof m &&
                    (h(p, g[d], m), f(a, c.join('.') + '.' + d, b.join('.') + '.' + g[d].join('.')));
            });
        }
        function n(a) {
        ...
        function e(a) {
            a.axes.forEach(function (c) {
                (c = c.options) &&
                    ...
                    (c.accessibility.description = c.description),
                    f(a, 'axis.description', 'axis.accessibility.description'));
            });
        }
        function t(a) {
            var c = {
            ...
            a.series.forEach(function (b) {
                Object.keys(c).forEach(function (d) {
                    var e = b.options[d];
                    'undefined' !== typeof e &&
                        (h(b.options, c[d], 'skipKeyboardNavigation' === d ? !e : e),
                        f(a, 'series.' + d, 'series.' + c[d].join('.')));
                });
            });
        }
        var p = a.error,
    ...
    r(a, 'modules/accessibility/a11y-i18n.js', [a['parts/Globals.js'], a['parts/Utilities.js']], function (a, f) {
        function h(a, f) {
            ...
            if (-1 < e) {
                ...
                if ((f = f[d[0]]))
                    for (
                        e = isNaN(e) ? f.length : e, e = 0 > e ? f.length + e : Math.min(e, f.length), d = 0;
                        d < e;
                        ++d
                    )
                        a += b + f[d] + h;
            ...
            return -1 < d
                ? ((h = a.substring(0, d)),
                  (a = Number(a.substring(d + 1, c))),
                  (f = f[h]),
                  !isNaN(a) &&
                      f &&
                      (0 > a
                          ? ((b = f[f.length + a]), 'undefined' === typeof b && (b = f[0]))
                          : ((b = f[a]), 'undefined' === typeof b && (b = f[f.length - 1]))),
    ...
    r(a, 'modules/accessibility/focusBorder.js', [a['parts/Globals.js'], a['parts/Utilities.js']], function (a, f) {
        function h(a) {
            if (!a.focusBorderDestroyHook) {
                ...
                a.destroy = function () {
                    var b, d;
                    null === (d = null === (b = a.focusBorder) || void 0 === b ? void 0 : b.destroy) || void 0 === d
                        ? void 0
                        : d.call(b);
        ...
        var e = f.addEvent,
            r = f.extend,
            p = f.pick,
            k = 'x y transform width height r d stroke-width'.split(' ');
        r(a.SVGElement.prototype, {
            addFocusBorder: function (d, c) {
                ...
                if ('text' === this.element.nodeName || this.isLabel) {
                    var r = !!this.rotation;
                    if (this.isLabel) var t = { x: r ? 1 : 0, y: 0 };
                    else
                        (f = t = 0),
                            'middle' === this.attr('text-anchor')
                                ? ((t = a.isFirefox && this.rotation ? 0.25 : 0.5),
                                  (f = a.isFirefox && !this.rotation ? 0.75 : 0.5))
                                : this.rotation
                                ? (t = 0.25)
                                : (f = 0.75),
                            (t = { x: t, y: f });
                    ...
                    this.isLabel &&
                        ...
                        (n = q),
                        (q = r),
                        (f = +this.attr('x') - b.height * t.x - e),
                        (k = +this.attr('y') - b.width * t.y - e));
                }
                this.focusBorder = this.renderer
                    .rect(f, k, n, q, parseInt(((c && c.borderRadius) || 0).toString(), 10))
                    .addClass('highcharts-focus-border')
                    .attr({ zIndex: 99 })
                    .add(this.parentGroup);
                this.renderer.styledMode ||
                    this.focusBorder.attr({ stroke: c && c.stroke, 'stroke-width': c && c.strokeWidth });
                l(this, d, c);
                h(this);
            },
        ...
        a.Chart.prototype.setFocusToElement = function (a, c) {
            ...
            (c = c || a.element) &&
                c.focus &&
                ((c.hcEvents && c.hcEvents.focusin) || e(c, 'focusin', function () {}),
                c.focus(),
    ...
    r(
        a,
        'modules/accessibility/accessibility.js',
        [
            a['modules/accessibility/utils/chartUtilities.js'],
            a['parts/Globals.js'],
            a['modules/accessibility/KeyboardNavigationHandler.js'],
            ...
            a['parts/Utilities.js'],
            a['modules/accessibility/AccessibilityComponent.js'],
            a['modules/accessibility/KeyboardNavigation.js'],
            a['modules/accessibility/components/LegendComponent.js'],
            a['modules/accessibility/components/MenuComponent.js'],
            a['modules/accessibility/components/SeriesComponent/SeriesComponent.js'],
            a['modules/accessibility/components/ZoomComponent.js'],
            a['modules/accessibility/components/RangeSelectorComponent.js'],
            a['modules/accessibility/components/InfoRegionsComponent.js'],
            a['modules/accessibility/components/ContainerComponent.js'],
            a['modules/accessibility/high-contrast-mode.js'],
            a['modules/accessibility/high-contrast-theme.js'],
            a['modules/accessibility/options/options.js'],
            a['modules/accessibility/options/langOptions.js'],
            a['modules/accessibility/options/deprecatedOptions.js'],
        ],
        function (a, f, q, l, n, e, r, p, k, d, c, b, g, m, v, A, B, u, z) {
            function h(a) {
                this.init(a);
            }
            var t = n.addEvent,
