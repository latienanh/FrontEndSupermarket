        ...
        b.downloadURL = function (d, e) {
            ...
            if ('string' === typeof d || d instanceof String || !c.msSaveOrOpenBlob) {
                ...
                if ('undefined' !== typeof f.download)
                    (f.href = d), (f.download = e), g.body.appendChild(f), f.click(), g.body.removeChild(f);
                else
                    try {
    ...
    e(c, 'modules/export-data.src.js', [c['parts/Globals.js'], c['parts/Utilities.js']], function (b, a) {
        ...
        b.Chart.prototype.getDataRows = function (a) {
            ...
            var w = u.categoryHeader,
                ...
                E = function (k, c, d) {
                    ...
                    return k
                        ? k instanceof b.Axis
                            ? (k.options.title && k.options.title.text) || (k.dateTime ? m : w)
                            : a
                            ? { columnTitle: 1 < d ? c : k.name, topLevelColumnTitle: k.name }
                            : k.name + (1 < d ? ' (' + c + ')' : '')
                        : w;
                },
                F = function (a, c, d) {
                    ...
                    k.options.data.forEach(function (a, b) {
                        ...
                        for (q[a].xValues[w] = h.x; g < l; )
                            (b = e[g]),
                                ...
                                (q[a][v + g] = t(
                                    z.categoryMap[b][n],
                                    z.dateTimeValueAxisMap[b] ? d.dateFormat(f.dateFormat, n) : null,
                                    n,
                                )),
                                g++;
                    });
            ...
            for (v = h.length; v--; ) {
                ...
                l.forEach(function (a) {
                    ...
                    x &&
                        !e(b) &&
                        (x.dateTime
                            ? (a.x instanceof Date && (a.x = a.x.getTime()), (b = d.dateFormat(f.dateFormat, a.x)))
                            : (b = x.categories ? t(x.names[a.x], x.categories[a.x], a.x) : a.x));
                    a.splice(g, 0, b);
                });
            }
            p = p.concat(l);
        ...
        b.Chart.prototype.getCSV = function (a) {
            ...
            c.forEach(function (a, d) {
                for (var g, l = a.length; l--; )
                    (g = a[l]),
                        'string' === typeof g && (g = '"' + g + '"'),
                        'number' === typeof g && '.' !== n && (g = g.toString().replace('.', n)),
                        (a[l] = g);
                b += a.join(f);
                d < c.length - 1 && (b += e);
            });
        ...
        b.Chart.prototype.getTable = function (a) {
            ...
            var f = 0,
                ...
                n = function (a, b, c, g) {
                    ...
                    b = 'text' + (b ? ' ' + b : '');
                    'number' === typeof h
                        ? ((h = h.toString()), ',' === d && (h = h.replace('.', d)), (b = 'number'))
                        : g || (b = 'empty');
            ...
            b += (function (a, b, d) {
                ...
                if (b) {
                    ...
                    for (d = b.length; h < d; ++h)
                        'undefined' !== typeof b[h] && (f += n('th', null, 'scope="col"', b[h]));
                    f += '</tr>';
                }
                return f + '</thead>';
        ...
        b.Chart.prototype.downloadXLS = function () {
            ...
            l(
                c(a, 'application/vnd.ms-excel') ||
                    'data:application/vnd.ms-excel;base64,' + d.btoa(unescape(encodeURIComponent(a))),
        ...
        if ((a = b.getOptions().exporting))
            G(a.menuItemDefinitions, {
                ...
                a.buttons &&
                    a.buttons.contextButton.menuItems.push('separator', 'downloadCSV', 'downloadXLS', 'viewData');
